 ...
 */
export function latitudeTemperature(latitude, equatorTemp, temperateTemp, poleTemp) {
...
export function planetaryAxes(p, cfg, tNoise = 0, mNoise = 0, latWarpNoise = 0) {
    ...
    const temperature = latitudeTemperature(warped, cfg.equatorTemp, cfg.temperateTemp, cfg.poleTemp) -
