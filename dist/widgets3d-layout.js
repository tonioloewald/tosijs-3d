 ...
 */
const logBase = (scale) => (scale === 'log2' ? 2 : 10);
/**
 ...
 */
export function fractionToValue(fraction, min, max, step = 0, scale = 'linear', snap = 0, zeroStop = false, precision = DEFAULT_SLIDER_PRECISION) {
