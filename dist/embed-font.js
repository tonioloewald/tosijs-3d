...
export function base64OfBytes(bytes) {
    let binary = '';
 ...
 */
export async function fontFaceCss(family, url, opts = {}) {
    ...
    const task = (async () => {
        ...
        if (!res.ok)
            throw new Error(`embed-font: ${url} → ${res.status}`);
 ...
 */
export function svgFontStyle(markup) {
...
//# sourceMappingURL=embed-font.js.map