...
export class B3d extends Component {
    ...
    */
    ...
    removeCavity(predicate) {
        const i = this._cavities.indexOf(predicate);
        if (i >= 0)
            this._cavities.splice(i, 1);
    }
     ...
     */
    get ambientPoolScale() {
        return this._ambientPoolScale;
    }
    set ambientPoolScale(scale) {
        const next = Math.max(0, Math.min(1, scale));
        if (next === this._ambientPoolScale)
            return;
            ...
            */
            this.addEventListener('pointerdown', (e) => {
                ...
                */
                ...
                if (path.includes(host) || path.includes(gear))
                    return;
                this._closeScenePanel();
            });
        }
