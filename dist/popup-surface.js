 ...
 */
function bringToFront(owner, front) {
    ...
    scene.onPointerObservable.add((info) => {
        ...
        if (onPopup != null) {
            ...
            */
            ...
            if (what === 'content')
                return; // the panel's own UI must reach it
            if (what === 'close') {
                target.close();
                return;
            }
    ...
    */
    ...
    const api = {
        ...
        close() {
            ...
            if (drag != null)
                plane.mesh?.removeBehavior(drag);
            const list = openPopups.get(owner);
            if (list != null) {
