...
export declare const tileFieldSampleCount: (subdivisions: number) => number;
 ...
 */
export declare function buildTileField(heightAt: (wx: number, wz: number) => number, cx: number, cz: number, subdivisions: number, tileSize: number, scratch: Float64Array, positions: Float32Array | number[], normals: Float32Array | number[], 
/**
