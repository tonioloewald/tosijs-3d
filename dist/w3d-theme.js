...
export const w3dTheme = {
    ...
    */
    codeFontFamily: cssVar('--w3d-code-font-family', 'ui-monospace, SFMono-Regular, Menlo, monospace'),
 ...
 * exists to avoid.
 */
export function setW3dTheme(partial) {
 ...
 * out.
 */
export function withTheme(partial, build) {
    const saved = {};
    for (const key of Object.keys(partial)) {
        saved[key] = w3dTheme[key];
    }
    setW3dTheme(partial);
    try {
        return build();
