 ...
 */
export declare function renderScalingLevel(tierScaling: number, xr: boolean, explicit: number | null | undefined, tierCap: number | undefined, devicePixelRatio: number): number;
/**
