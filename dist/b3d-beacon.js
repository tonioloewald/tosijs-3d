 ...
 */
export function beaconOwner(mesh) {
...
export class B3dBeacon extends AbstractMesh {
    ...
    render() {
        ...
        if (scene != null && this._key() !== this._built)
            this._build(scene);
    ...
    _build(scene) {
        ...
        */
        this.mesh =
            this.shape === 'sphere'
                ? BABYLON.MeshBuilder.CreateSphere('beacon', { diameterX: w, diameterY: h, diameterZ: d }, scene)
                : BABYLON.MeshBuilder.CreateBox('beacon', { width: w, height: h, depth: d }, scene);
    ...
    _hostPosition() {
        ...
        if (host.light?.position != null)
            return host.light.position;
        return null;
    }
}
export const b3dBeacon = B3dBeacon.elementCreator();
//# sourceMappingURL=b3d-beacon.js.map