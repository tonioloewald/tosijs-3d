...
export class B3dRadar extends B3dChild {
    ...
    _host = null;
    _fwd = new BABYLON.Vector3(0, 0, 1);
    _acc = 0; // seconds accumulated toward the next refresh
    ...
    _tick = () => {
        ...
        this._radar.update({ x: pos.x, y: pos.y, z: pos.z }, { x: this._fwd.x, y: this._fwd.y, z: this._fwd.z }, contacts, this._acc);
        this._acc = 0;
    };
...
export const b3dRadar = B3dRadar.elementCreator({ tag: 'tosi-b3d-radar' });
//# sourceMappingURL=b3d-radar.js.map