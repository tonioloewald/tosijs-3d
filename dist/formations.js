 ...
 */
export function ring(count, radius, opts = {}) {
 ...
 */
export function vee(count, opts = {}) {
 ...
 */
export function escorts(count, radius, opts = {}) {
...
export function line(count, spacing) {
    if (count <= 0)
        return [];
...
export function at(centre, offsets) {
