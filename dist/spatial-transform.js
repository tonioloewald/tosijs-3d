 ...
 */
export const composePose = (parent, local) => ({
 ...
 */
export const relativePose = (parent, childWorld) => {
 ...
 */
export const placeRelative = (ref, offset) => add(ref.position, rotateVector(ref.rotation, offset));
//# sourceMappingURL=spatial-transform.js.map