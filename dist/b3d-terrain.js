...
export class B3dTerrain extends Component {
    ...
    heightAt(wx, wz) {
        ...
        const grossRaw = this.noise.fractal(surfPt.x * attrs.grossScale, surfPt.y * attrs.grossScale, surfPt.z * attrs.grossScale, 4);
        const detailRaw = this.noise.fractal(surfPt.x * attrs.detailScale, surfPt.y * attrs.detailScale, surfPt.z * attrs.detailScale, 3);
