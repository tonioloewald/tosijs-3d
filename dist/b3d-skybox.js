    ...
    _buildStarfield(scene) {
        ...
        */
        ...
        if (dataRoot && typeof mat0?.setTexture === 'function') {
            ...
            */
            mat0.setVector4('b3dStarInfo', new BABYLON.Vector4(n, Math.PI / 2 / n, Number(attrs.starfieldSharpness) || 1, Number(attrs.starfieldSizeScale) || 3));
        }
        if (cubeRoot) {
