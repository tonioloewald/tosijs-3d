import { ShaderMaterial, Scene, Vector2, Color4 } from '@babylonjs/core'
...
export function createRipplingWaterShader(
  name: string,
  scene: Scene,
  options: WaterRippleShaderOptions = {}
): ShaderMaterial {
  const {
    size = 1,
    waveSpeed1 = 0.5,
    ...
    waveHeight1 = 0.1,
    waveHeight2 = 0.08,
    waveDirection1 = new Vector2(1, 0),
    waveDirection2 = new Vector2(0.7, 0.7),
    baseColor = '#005070',
  } = options
