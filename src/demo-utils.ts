 ...
 */
export function demoSun(opts: DemoSunOptions = {}) {
 ...
 * merely bland.
 */
export function patternGround(opts: PatternGroundOptions = {}) {
 ...
 */
export function demoStage(opts: DemoStageOptions = {}) {
 ...
 */
export function spinner(el: DemoHost, opts: SpinnerOptions = {}): BABYLON.Mesh {
  ...
  if (texture) mat.diffuseTexture = new BABYLON.Texture(texture, el.scene)
  box.material = mat
