...
export function ellipsize(
  ...
  while (lo < hi) {
    ...
    if (measureTextWidth(text.slice(0, mid), font) + dots <= maxWidth) lo = mid
    else hi = mid - 1
  }
