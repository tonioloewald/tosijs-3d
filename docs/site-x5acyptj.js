import{_B as b}from"./site-7jxv124x.js";var f="decalFragmentDeclaration",y=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;if(!b.IncludesShadersStore[f])b.IncludesShadersStore[f]=y;var H={name:f,shader:y};var k="prePassDeclaration",z=`#ifdef PREPASS
...
#endif
#endif
`;if(!b.IncludesShadersStore[k])b.IncludesShadersStore[k]=z;var K={name:k,shader:z};var q="oitDeclaration",A=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;if(!b.IncludesShadersStore[q])b.IncludesShadersStore[q]=A;var Q={name:q,shader:A};var v="textureRepetitionFunctions",B=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!b.IncludesShadersStore[v])b.IncludesShadersStore[v]=B;var W={name:v,shader:B};var w="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!b.IncludesShadersStore[w])b.IncludesShadersStore[w]=C;var Z={name:w,shader:C};
export{H as xy,K as yy,Q as zy,W as Ay,Z as By};

//# debugId=7BDB82AB310513D864756E2164756E21
//# sourceMappingURL=site-x5acyptj.js.map
