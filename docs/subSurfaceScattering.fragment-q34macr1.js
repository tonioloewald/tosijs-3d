import{Ij as D}from"./site-mw6n3pm9.js";import{Wy as C}from"./site-58j2ewnw.js";import{_B as k}from"./site-7jxv124x.js";import"./site-68gwymhw.js";var v="fibonacci",y=`#define rcp(x) 1./x
#define GOLDEN_RATIO 1.618033988749895
vec2 Golden2dSeq(int i,float n)
{return vec2(float(i)/n+(0.5/n),fract(float(i)*rcp(GOLDEN_RATIO)));}
vec2 SampleDiskGolden(int i,int sampleCount)
{vec2 f=Golden2dSeq(i,float(sampleCount));return vec2(sqrt(f.x),TWO_PI*f.y);}`;if(!k.IncludesShadersStore[v])k.IncludesShadersStore[v]=y;var z={name:v,shader:y};var w="diffusionProfile",A="uniform vec3 diffusionS[5];uniform float diffusionD[5];uniform float filterRadii[5];";if(!k.IncludesShadersStore[w])k.IncludesShadersStore[w]=A;var B={name:w,shader:A};var x="subSurfaceScatteringPixelShader",G=`#include<helperFunctions>
#include<fibonacci>
...
totalWeight=max(totalWeight,HALF_MIN);gl_FragColor=vec4(inputColor.rgb+albedo*max(totalIrradiance/totalWeight,vec3(0.0)),1.);}`;if(!k.ShadersStore[x])k.ShadersStore[x]=G;var H=[C,z,D,B];for(let q of H)if(!k.IncludesShadersStore[q.name])k.IncludesShadersStore[q.name]=q.shader;var Y={name:x,shader:G};export{Y as subSurfaceScatteringPixelShader};

//# debugId=30E3C503205F3C0764756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-q34macr1.js.map
