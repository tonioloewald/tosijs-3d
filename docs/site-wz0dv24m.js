import{_B as b}from"./site-7jxv124x.js";var k="fluidRenderingBilateralBlurPixelShader",q=`uniform sampler2D textureSampler;uniform int maxFilterSize;uniform vec2 blurDir;uniform float projectedParticleConstant;uniform float depthThreshold;varying vec2 vUV;void main(void) {float depth=textureLod(textureSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(vec3(depth),1.);return;}
...
//# debugId=6632E35758B21BB164756E2164756E21
//# sourceMappingURL=site-wz0dv24m.js.map
