import{_B as b}from"./site-7jxv124x.js";var f="importanceSampling",q=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;if(!b.IncludesShadersStoreWGSL[f])b.IncludesShadersStoreWGSL[f]=q;var x={name:f,shader:q};var k="hdrFilteringFunctions",v=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;if(!b.IncludesShadersStoreWGSL[k])b.IncludesShadersStoreWGSL[k]=v;var A={name:k,shader:v};
export{x as sj,A as tj};

//# debugId=01AEC6FF881E375164756E2164756E21
//# sourceMappingURL=site-pjq9c2vh.js.map
