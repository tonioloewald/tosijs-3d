import{Qi as tq,Ri as mq,Si as Sq,Ti as dq,Ui as pq}from"./site-fp9s0qz7.js";import{Vi as hq}from"./site-6sxrrz6z.js";import{ij as Dq,jj as Eq,kj as Rq,lj as Mq,mj as Lq,nj as uq,oj as cq,pj as gq,qj as iq}from"./site-7zm2vj66.js";import{rj as Uq}from"./site-z0ma7nw3.js";import{sj as lq,tj as bq}from"./site-jb9yaend.js";import{uj as Fq,vj as jq}from"./site-jct097fn.js";import{xj as Nq}from"./site-e4mpgsvc.js";import{tk as Bq}from"./site-1w83fgaf.js";import{Vz as vq,Wz as Gq,Xz as kq,Yz as yq}from"./site-1szy91x0.js";import{Zz as Aq}from"./site-gvnrjj0h.js";import{_z as Iq}from"./site-4yv0qmr9.js";import{$z as Vq}from"./site-4gewpr5c.js";import{aA as fq}from"./site-mfy2m7vn.js";import{bA as Wq}from"./site-qr2bwqkn.js";import{cA as zq}from"./site-mtg7dm63.js";import{dA as Cq}from"./site-g3p15j1t.js";import{eA as Pq}from"./site-k3tc6dn5.js";import{fA as Tq}from"./site-f96ys6rt.js";import{gA as Oq}from"./site-1w2bjfmq.js";import{iA as _q}from"./site-4j4mb0f9.js";import{jA as Zq}from"./site-0asqx2x4.js";import{kA as $q}from"./site-jzegcmyz.js";import{lA as Yq}from"./site-2zb4ht88.js";import{mA as Xq}from"./site-mvqptzb8.js";import{EA as Jq}from"./site-wy8z6msz.js";import{FA as Qq}from"./site-h2yr8kje.js";import{GA as Kq}from"./site-g0mfbjb2.js";import{HA as Hq}from"./site-gh3wrscr.js";import{_B as q}from"./site-1q3afg48.js";var x="openpbrFragmentSamplersDeclaration",T=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;if(!q.IncludesShadersStoreWGSL[x])q.IncludesShadersStoreWGSL[x]=T;var k={name:x,shader:T};var H="openpbrNormalMapFragmentMainFunctions",A=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;if(!q.IncludesShadersStoreWGSL[H])q.IncludesShadersStoreWGSL[H]=A;var O={name:H,shader:A};var J="openpbrNormalMapFragmentFunctions",y=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;if(!q.IncludesShadersStoreWGSL[J])q.IncludesShadersStoreWGSL[J]=y;var B={name:J,shader:y};var K="openpbrConductorReflectance",N=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;if(!q.IncludesShadersStoreWGSL[K])q.IncludesShadersStoreWGSL[K]=N;var D={name:K,shader:N};var Q="openpbrAmbientOcclusionFunctions",F=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;if(!q.IncludesShadersStoreWGSL[Q])q.IncludesShadersStoreWGSL[Q]=F;var U={name:Q,shader:F};var X="openpbrVolumeFunctions",l=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;if(!q.IncludesShadersStoreWGSL[X])q.IncludesShadersStoreWGSL[X]=l;var E={name:X,shader:l};var Y="openpbrNormalMapFragment",R=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!q.IncludesShadersStoreWGSL[Y])q.IncludesShadersStoreWGSL[Y]=R;var M={name:Y,shader:R};var Z="openpbrBlockNormalFinal",b=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[Z])q.IncludesShadersStoreWGSL[Z]=b;var L={name:Z,shader:b};var _="openpbrBaseLayerData",u=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;if(!q.IncludesShadersStoreWGSL[_])q.IncludesShadersStoreWGSL[_]=u;var j={name:_,shader:u};var $="openpbrCoatLayerData",c=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;if(!q.IncludesShadersStoreWGSL[$])q.IncludesShadersStoreWGSL[$]=c;var g={name:$,shader:c};var v="openpbrThinFilmLayerData",i=`#ifdef THIN_FILM
...
#endif
`;if(!q.IncludesShadersStoreWGSL[v])q.IncludesShadersStoreWGSL[v]=i;var t={name:v,shader:i};var G="openpbrFuzzLayerData",m=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[G])q.IncludesShadersStoreWGSL[G]=m;var S={name:G,shader:m};var I="openpbrAmbientOcclusionData",d=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;if(!q.IncludesShadersStoreWGSL[I])q.IncludesShadersStoreWGSL[I]=d;var p={name:I,shader:d};var V="openpbrBackgroundTransmission",h=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;if(!q.IncludesShadersStoreWGSL[V])q.IncludesShadersStoreWGSL[V]=h;var o={name:V,shader:h};var W="openpbrEnvironmentLighting",s=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;if(!q.IncludesShadersStoreWGSL[W])q.IncludesShadersStoreWGSL[W]=s;var n={name:W,shader:s};var f="openpbrDirectLightingInit",r=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[f])q.IncludesShadersStoreWGSL[f]=r;var a={name:f,shader:r};var z="openpbrDirectLighting",e=`#ifdef LIGHT{X}
...
#endif
`;if(!q.IncludesShadersStoreWGSL[z])q.IncludesShadersStoreWGSL[z]=e;var qq={name:z,shader:e};var C="openpbrBlockPrePass",wq=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[C])q.IncludesShadersStoreWGSL[C]=wq;var xq={name:C,shader:wq};var P="openpbrPixelShader",oq=`#define OPENPBR_FRAGMENT_SHADER
...
`;if(!q.ShadersStoreWGSL[P])q.ShadersStoreWGSL[P]=oq;var sq=[vq,Gq,Xq,Yq,hq,_q,Dq,Iq,zq,Fq,k,Pq,Hq,$q,Jq,kq,Zq,Uq,lq,Eq,Tq,fq,Nq,Vq,Rq,Mq,Bq,bq,Wq,Lq,uq,jq,O,B,Cq,tq,D,U,mq,Sq,E,Kq,cq,M,L,j,pq,dq,g,t,S,p,Aq,o,n,a,qq,Oq,Qq,gq,xq,yq,iq];for(let w of sq)if(!q.IncludesShadersStoreWGSL[w.name])q.IncludesShadersStoreWGSL[w.name]=w.shader;var dx={name:P,shader:oq};
export{dx as Pi};

//# debugId=674B3AEEB44A816564756E2164756E21
//# sourceMappingURL=site-2gpywt46.js.map
