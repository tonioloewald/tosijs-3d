import{vk as n}from"./site-p62pmthq.js";import{wk as r}from"./site-9mq3sfzz.js";import{Wy as o}from"./site-stjjqyz5.js";import{_B as e}from"./site-ea0e8ybd.js";var i="screenSpaceReflection2PixelShader",l=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;if(!e.ShadersStore[i])e.ShadersStore[i]=l;var c=[o,r,n];for(let t of c)if(!e.IncludesShadersStore[t.name])e.IncludesShadersStore[t.name]=t.shader;var d={name:i,shader:l};
export{d as uk};

//# debugId=756485D86058E8EA64756E2164756E21
//# sourceMappingURL=site-fpy2ppd6.js.map
