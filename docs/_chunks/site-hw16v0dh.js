import{xe,ve}from"./site-t5na8t3j.js";import{Sa,ya,Ta}from"./site-p6fvga56.js";import{Ca,ws}from"./site-vx9qbk6e.js";import{te}from"./site-ybnjbk1z.js";import{ko,Vo}from"./site-a75ec5xt.js";import{xt}from"./site-23zackra.js";import{xr}from"./site-jqf0yjpr.js";import{Ku,Zu,Ju,eh,th}from"./site-wn35mznw.js";import{i}from"./site-1yf4ncc8.js";var r="geometryPixelShader",f=`#ifdef BUMP
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=f;var n=[xe,Sa,Ca,ya,te,ko,xt,xr,Ku,Vo,ws,Zu,Ju,ve,Ta,eh,th];for(let e of n)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var yT={name:r,shader:f};
export{yT};

//# debugId=861D2BD90B6A0B4564756E2164756E21
//# sourceMappingURL=site-hw16v0dh.js.map
