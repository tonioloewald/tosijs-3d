import{i}from"./site-1yf4ncc8.js";var e="lightFragment",n=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=n;var ni={name:e,shader:n};var t="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=f;var ma={name:t,shader:f};var o="decalFragment",d=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=d;var qh={name:o,shader:d};
export{ma,qh,ni};

//# debugId=6CCF72A1230CD18364756E2164756E21
//# sourceMappingURL=site-4txygyx5.js.map
