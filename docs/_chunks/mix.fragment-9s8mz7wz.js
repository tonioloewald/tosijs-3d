import{te}from"./site-ybnjbk1z.js";import{$t,qt,Ti}from"./site-hsewys6t.js";import{Ri}from"./site-t1e923cw.js";import{xe,ve}from"./site-t5na8t3j.js";import{W}from"./site-6bak08eg.js";import{tt,Ye}from"./site-m1s81bf3.js";import{ai}from"./site-ndpmtms5.js";import{We}from"./site-cr62e97z.js";import{Mi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var f="mixPixelShader",r=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;if(!i.ShadersStoreWGSL[f])i.ShadersStoreWGSL[f]=r;var o=[te,$t,Ri,qt,xe,W,tt,ve,Ti,ai,We,Ye,Mi];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var x={name:f,shader:r};export{x as mixPixelShaderWGSL};

//# debugId=484AF3F0E50D1CA464756E2164756E21
//# sourceMappingURL=mix.fragment-9s8mz7wz.js.map
