import{_B as e}from"./site-ea0e8ybd.js";var t="importanceSampling",a=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;if(!e.IncludesShadersStore[t])e.IncludesShadersStore[t]=a;var l={name:t,shader:a};var i="hdrFilteringFunctions",n=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;if(!e.IncludesShadersStore[i])e.IncludesShadersStore[i]=n;var r={name:i,shader:n};
export{l as Jj,r as Kj};

//# debugId=6667FFCE6A6867BD64756E2164756E21
//# sourceMappingURL=site-gsfcdg3k.js.map
