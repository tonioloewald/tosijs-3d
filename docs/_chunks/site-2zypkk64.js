import{i}from"./site-1yf4ncc8.js";var e="sceneFragmentDeclaration",c=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;uniform mat4 inverseProjection;
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=c;var Tn={name:e,shader:c};var n="openpbrDielectricReflectance",f=`struct ReflectanceParams
...
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=f;var rh={name:n,shader:f};var r="openpbrGeometryInfo",s=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=s;var sh={name:r,shader:s};var o="openpbrIblFunctions",l=`#ifdef REFLECTION
...
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=l;var nh={name:o,shader:l};var a="openpbrSubsurfaceLayerData",d=`float subsurface_weight=vSubsurfaceWeight;vec3 subsurface_color=vSubsurfaceColor.rgb;float subsurface_radius=vSubsurfaceRadius;vec3 subsurface_radius_scale=vSubsurfaceRadiusScale;float subsurface_scatter_anisotropy=clamp(vSubsurfaceScatterAnisotropy,-0.9999,0.9999);
...
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=m;var oh={name:t,shader:m};
export{Tn,rh,sh,nh,ah,oh};

//# debugId=649E38CDF15DB6F964756E2164756E21
//# sourceMappingURL=site-2zypkk64.js.map
