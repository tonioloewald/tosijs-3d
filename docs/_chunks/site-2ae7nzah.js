import{ki as R}from"./site-014t47kf.js";import{Pz as p}from"./site-pc7wx50v.js";import{Rz as L}from"./site-gggacazs.js";import{_z as v}from"./site-3njbfktn.js";import{$z as u}from"./site-s8vfkdrs.js";import{aA as g}from"./site-10kj1b29.js";import{bA as S}from"./site-b510f2ch.js";import{dA as E}from"./site-asbfwt8t.js";import{eA as F}from"./site-55fjnmm4.js";import{fA as C}from"./site-s8a42t29.js";import{gA as h}from"./site-p3qvxbqn.js";import{jA as d}from"./site-t4ayqvvy.js";import{kA as m}from"./site-ngcgfsjk.js";import{mA as s}from"./site-1nn7frmg.js";import{EA as l}from"./site-j1mr7gyn.js";import{FA as c}from"./site-kcvb8kks.js";import{GA as a}from"./site-4ghhz517.js";import{HA as t}from"./site-42gdhacc.js";import{_B as e}from"./site-ea0e8ybd.js";var o="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;if(!e.IncludesShadersStoreWGSL[o])e.IncludesShadersStoreWGSL[o]=f;var n={name:o,shader:f};var i="backgroundPixelShader",I=`#include<backgroundUboDeclaration>
...
`;if(!e.ShadersStoreWGSL[i])e.ShadersStoreWGSL[i]=I;var D=[s,R,d,E,F,v,u,S,p,g,C,m,t,l,n,a,L,h,c];for(let r of D)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var j={name:i,shader:I};
export{n as ii,j as ji};

//# debugId=325F8159E7E3A50364756E2164756E21
//# sourceMappingURL=site-2ae7nzah.js.map
