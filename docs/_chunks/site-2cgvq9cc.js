import{_B as e}from"./site-ea0e8ybd.js";var a="importanceSampling",t=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;if(!e.IncludesShadersStoreWGSL[a])e.IncludesShadersStoreWGSL[a]=t;var n={name:a,shader:t};var f="hdrFilteringFunctions",i=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=i;var l={name:f,shader:i};
export{n as sj,l as tj};

//# debugId=B55E7DB9993005A664756E2164756E21
//# sourceMappingURL=site-2cgvq9cc.js.map
