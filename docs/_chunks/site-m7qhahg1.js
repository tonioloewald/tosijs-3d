import{_B as e}from"./site-ea0e8ybd.js";var r="prePassDeclaration",v=`#ifdef PREPASS
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[r])e.IncludesShadersStoreWGSL[r]=v;var s={name:r,shader:v};var t="oitDeclaration",d=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=d;var p={name:t,shader:d};var f="textureRepetitionFunctions",o=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=o;var m={name:f,shader:o};var a="oitFragment",c=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!e.IncludesShadersStoreWGSL[a])e.IncludesShadersStoreWGSL[a]=c;var E={name:a,shader:c};
export{s as Vz,p as Wz,m as Xz,E as Yz};

//# debugId=B800EFD43B61B02264756E2164756E21
//# sourceMappingURL=site-m7qhahg1.js.map
