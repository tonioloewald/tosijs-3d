import{i}from"./site-1yf4ncc8.js";var e="gaussianSplattingVertexDeclaration",s="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=s;var Ga={name:e,shader:s};var t="gaussianSplatting",o=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=o;var za={name:t,shader:o};var a="gaussianSplattingUboDeclaration",c=`#include<sceneUboDeclaration>
...
`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=c;var tl={name:a,shader:c};
export{Ga,tl,za};

//# debugId=8C0AFBF3A950DA7C64756E2164756E21
//# sourceMappingURL=site-rx8t2h58.js.map
