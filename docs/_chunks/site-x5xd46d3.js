import{Qo,Ko,Zo,Ce,Ee,ea,Xt,Wr,Hr,Jo,yi,el}from"./site-b1m3rnst.js";import{ma,qh,ni}from"./site-4txygyx5.js";import{St}from"./site-qq23efnd.js";import{ji}from"./site-xdbjmd04.js";import{tf}from"./site-jp4nnsty.js";import{bs}from"./site-22qg3tyt.js";import{ie}from"./site-7h7pyq2a.js";import{va,Ms}from"./site-20tfmyw7.js";import{_a,ga,xa}from"./site-qttfwy7v.js";import{Ae,Se}from"./site-8vh88wsk.js";import{H}from"./site-rze70emw.js";import{Ze,it}from"./site-zyk6zjdn.js";import{Ke}from"./site-mcwrng38.js";import{i}from"./site-1yf4ncc8.js";var o="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=f;var Ai={name:o,shader:f};var r="fresnelFunction",l=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=l;var i0={name:r,shader:l};var t="defaultFragmentDeclaration",a=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=a;var c={name:t,shader:a};var n="defaultPixelShader",s=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;if(!i.ShadersStore[n])i.ShadersStore[n]=s;var d=[Qo,c,St,ji,tf,Ko,Zo,bs,ie,Ce,Ee,ea,ma,Ai,Xt,va,i0,Ms,Wr,Hr,Jo,_a,ga,Ae,H,Ze,Se,xa,qh,yi,ni,Ke,it,el];for(let e of d)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var r0={name:n,shader:s};
export{Ai,i0,r0};

//# debugId=788D78882D92B9BE64756E2164756E21
//# sourceMappingURL=site-x5xd46d3.js.map
