import{i}from"./site-1yf4ncc8.js";var e="bonesDeclaration",s=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=s;var He={name:e,shader:s};var t="bonesVertex",d=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=d;var Ge={name:t,shader:d};var r="bakedVertexAnimationDeclaration",m=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=m;var Xe={name:r,shader:m};var n="instancesDeclaration",o=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=o;var Be={name:n,shader:o};var a="instancesVertex",u=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=u;var Me={name:a,shader:u};var f="bakedVertexAnimation",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=c;var Ue={name:f,shader:c};
export{He,Xe,Be,Me,Ge,Ue};

//# debugId=105B803E0E8A3C2664756E2164756E21
//# sourceMappingURL=site-sfve3vze.js.map
