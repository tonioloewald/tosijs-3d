import{i}from"./site-1yf4ncc8.js";var e="morphTargetsVertexGlobalDeclaration",d=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=d;var fr={name:e,shader:d};var r="morphTargetsVertexDeclaration",a=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=a;var dr={name:r,shader:a};var t="morphTargetsVertexGlobal",o=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=o;var br={name:t,shader:o};var n="morphTargetsVertex",f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=f;var Sr={name:n,shader:f};
export{fr,dr,br,Sr};

//# debugId=EC50934543DF217464756E2164756E21
//# sourceMappingURL=site-ze3cj5gn.js.map
