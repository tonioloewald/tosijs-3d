import{_B as k}from"./site-1q3afg48.js";var q="pbrFragmentReflectionDeclaration",w=`#ifdef REFLECTION
...
#endif
#endif
`;if(!k.IncludesShadersStoreWGSL[q])k.IncludesShadersStoreWGSL[q]=w;var z={name:q,shader:w};var v="pbrIBLFunctions",x=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;if(!k.IncludesShadersStoreWGSL[v])k.IncludesShadersStoreWGSL[v]=x;var G={name:v,shader:x};
export{z as uj,G as vj};

//# debugId=ED66F5834396A69864756E2164756E21
//# sourceMappingURL=site-jct097fn.js.map
