...
`;if(!i.ShadersStore[r])i.ShadersStore[r]=o;var f=[ie,Ce,Ee,Ai,Xt,Ae,H,Ze,Se,yi,ni,Ke,it,_i];for(let e of f)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var x={name:r,shader:o};export{x as terrainPixelShader};

//# debugId=5C473D6C8813705C64756E2164756E21
//# sourceMappingURL=terrain.fragment-26q6v5ha.js.map
