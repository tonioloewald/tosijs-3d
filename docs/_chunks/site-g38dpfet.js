import{i}from"./site-1yf4ncc8.js";var e="bonesDeclaration",d=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=d;var Fe={name:e,shader:d};var t="bonesVertex",f=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=f;var Be={name:t,shader:f};var r="bakedVertexAnimationDeclaration",o=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=o;var Ve={name:r,shader:o};var n="instancesDeclaration",s=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=s;var Ae={name:n,shader:s};var a="instancesVertex",c=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=c;var Ce={name:a,shader:c};var m="bakedVertexAnimation",E=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;if(!i.IncludesShadersStore[m])i.IncludesShadersStore[m]=E;var Ge={name:m,shader:E};
export{Fe,Ve,Ae,Ce,Be,Ge};

//# debugId=09850D8E320718A264756E2164756E21
//# sourceMappingURL=site-g38dpfet.js.map
