import{xt}from"./site-23zackra.js";import{Di}from"./site-v7w00mev.js";import{Va}from"./site-g1s9749m.js";import{i}from"./site-1yf4ncc8.js";var e="gaussianSplattingVoxelVertexShader",r=`#include<sceneUboDeclaration>
...
`;if(!i.ShadersStoreWGSL[e])i.ShadersStoreWGSL[e]=r;var a=[xt,Di,Va];for(let t of a)if(!i.IncludesShadersStoreWGSL[t.name])i.IncludesShadersStoreWGSL[t.name]=t.shader;var p={name:e,shader:r};export{p as gaussianSplattingVoxelVertexShaderWGSL};

//# debugId=031F8C4D3A7F348F64756E2164756E21
//# sourceMappingURL=gaussianSplattingVoxel.vertex-4qdayden.js.map
