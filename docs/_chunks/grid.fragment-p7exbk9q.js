import{Me,Ee}from"./site-qtq2tkrz.js";import{Y}from"./site-kthp3mjc.js";import{rt,ot}from"./site-m57amydx.js";import{it}from"./site-zcgrc802.js";import{Ei}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var e="gridPixelShader",n=`#extension GL_OES_standard_derivatives : enable
...
`;if(!i.ShadersStore[e])i.ShadersStore[e]=n;var r=[Me,Y,rt,Ee,ot,it,Ei];for(let o of r)if(!i.IncludesShadersStore[o.name])i.IncludesShadersStore[o.name]=o.shader;var g={name:e,shader:n};export{g as gridPixelShader};

//# debugId=2A1D099C27B6134564756E2164756E21
//# sourceMappingURL=grid.fragment-p7exbk9q.js.map
