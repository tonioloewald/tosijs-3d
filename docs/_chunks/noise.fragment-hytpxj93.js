import{_B as b}from"./site-1q3afg48.js";import"./site-cxzb117e.js";var k="noisePixelShader",l=`uniform brightness: f32;uniform persistence: f32;uniform timeScale: f32;varying vUV: vec2f;fn hash22(input: vec2f)->vec2f {var p=vec2f(dot(input,vec2f(127.1,311.7)),dot(input,vec2f(269.5,183.3)));p=-vec2f(1.0)+2.0*fract(sin(p)*43758.5453123);return sin(p*6.283+uniforms.timeScale);}
...
`;if(!b.ShadersStoreWGSL[k])b.ShadersStoreWGSL[k]=l;var v={name:k,shader:l};export{v as noisePixelShaderWGSL};

//# debugId=5FBBABE8CEA55A4E64756E2164756E21
//# sourceMappingURL=noise.fragment-hytpxj93.js.map
