import{Oj as E}from"./site-3cbxmvsm.js";import{$x as A}from"./site-mz51h8m4.js";import{ky as F}from"./site-a7t3w6tt.js";import{ly as _}from"./site-p3a38267.js";import{my as k}from"./site-8azsvrvv.js";import{ny as $}from"./site-me4sbwwy.js";import{Yy as Z}from"./site-vsp6hkzp.js";import{bz as O}from"./site-dwr5s1ha.js";import{cz as Q}from"./site-z5fa4raw.js";import{dz as K,ez as X}from"./site-zx8qtfzw.js";import{fz as J}from"./site-f2k7n4ns.js";import{gz as W}from"./site-2e30jbpw.js";import{jz as Y}from"./site-510tzh5c.js";import{kz as N}from"./site-kw5vzqp8.js";import{_B as f}from"./site-1q3afg48.js";var v="geometryVertexDeclaration",B="uniform mat4 viewProjection;uniform mat4 view;";if(!f.IncludesShadersStore[v])f.IncludesShadersStore[v]=B;var C={name:v,shader:B};var w="geometryUboDeclaration",H=`#include<sceneUboDeclaration>
`;if(!f.IncludesShadersStore[w])f.IncludesShadersStore[w]=H;var I={name:w,shader:H};var z="geometryVertexShader",G=`precision highp float;
...
`;if(!f.ShadersStore[z])f.ShadersStore[z]=G;var L=[J,K,_,$,O,C,Z,I,N,E,F,k,Q,W,X,Y,A];for(let q of L)if(!f.IncludesShadersStore[q.name])f.IncludesShadersStore[q.name]=q.shader;var n={name:z,shader:G};
export{n as Li};

//# debugId=F00B3439417DB6CD64756E2164756E21
//# sourceMappingURL=site-mncpawn1.js.map
