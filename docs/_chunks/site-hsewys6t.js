...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=u;var $t={name:e,shader:u};var r="shadowsFragmentFunctions",l=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=l;var qt={name:r,shader:l};var t="imageProcessingDeclaration",n=`#ifdef EXPOSURE
...
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=n;var Lr={name:t,shader:n};var a="imageProcessingFunctions",h=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=h;var Fr={name:a,shader:h};var o="prePassDeclaration",m=`#ifdef PREPASS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=m;var ul={name:o,shader:m};var f="oitDeclaration",S=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=S;var hl={name:f,shader:S};var v="ltcHelperFunctions",x=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;if(!i.IncludesShadersStoreWGSL[v])i.IncludesShadersStoreWGSL[v]=x;var ta={name:v,shader:x};var s="clusteredLightingFunctions",w=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=w;var hn={name:s,shader:w};var c="textureRepetitionFunctions",g=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!i.IncludesShadersStoreWGSL[c])i.IncludesShadersStoreWGSL[c]=g;var fl={name:c,shader:g};var d="depthPrePass",T=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=T;var Ti={name:d,shader:T};var p="oitFragment",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!i.IncludesShadersStoreWGSL[p])i.IncludesShadersStoreWGSL[p]=y;var dl={name:p,shader:y};
export{ul,hl,$t,ta,hn,qt,Lr,Fr,fl,Ti,dl};

//# debugId=623554CBDAFC43F764756E2164756E21
//# sourceMappingURL=site-hsewys6t.js.map
