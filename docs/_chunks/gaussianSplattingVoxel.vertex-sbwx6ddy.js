import{Ct}from"./site-czf9pgne.js";import{Ui}from"./site-egwk4kn6.js";import{To}from"./site-jfsj4mx1.js";import{i}from"./site-1yf4ncc8.js";var e="gaussianSplattingVoxelVertexShader",r=`#include<sceneUboDeclaration>
...
`;if(!i.ShadersStoreWGSL[e])i.ShadersStoreWGSL[e]=r;var a=[Ct,Ui,To];for(let t of a)if(!i.IncludesShadersStoreWGSL[t.name])i.IncludesShadersStoreWGSL[t.name]=t.shader;var p={name:e,shader:r};export{p as gaussianSplattingVoxelVertexShaderWGSL};

//# debugId=7EDAAE5DDE23175B64756E2164756E21
//# sourceMappingURL=gaussianSplattingVoxel.vertex-sbwx6ddy.js.map
