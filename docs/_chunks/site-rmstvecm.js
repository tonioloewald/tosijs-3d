import{i}from"./site-1yf4ncc8.js";var e="pbrFragmentExtraDeclaration",g=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=g;var yf={name:e,shader:g};var t="subSurfaceScatteringFunctions",u=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=u;var Ml={name:t,shader:u};var o="importanceSampling",E=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=E;var sa={name:o,shader:E};var a="pbrHelperFunctions",h=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=h;var Tf={name:a,shader:h};var r="pbrDirectLightingSetupFunctions",p=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=p;var Cf={name:r,shader:p};var n="pbrDirectLightingFalloffFunctions",L=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=L;var Ef={name:n,shader:L};var l="hdrFilteringFunctions",D=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;if(!i.IncludesShadersStore[l])i.IncludesShadersStore[l]=D;var na={name:l,shader:D};var f="pbrDirectLightingFunctions",m=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;if(!i.IncludesShadersStore[f])i.IncludesShadersStore[f]=m;var Af={name:f,shader:m};var c="pbrBlockNormalGeometric",v=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;if(!i.IncludesShadersStore[c])i.IncludesShadersStore[c]=v;var Rf={name:c,shader:v};var s="pbrBlockImageProcessing",A=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!i.IncludesShadersStore[s])i.IncludesShadersStore[s]=A;var If={name:s,shader:A};var d="pbrDebug",C=`#if DEBUGMODE>0
...
#endif
`;if(!i.IncludesShadersStore[d])i.IncludesShadersStore[d]=C;var Pf={name:d,shader:C};
export{yf,Ml,sa,Tf,Cf,Ef,na,Af,Rf,If,Pf};

//# debugId=8532383354588DFF64756E2164756E21
//# sourceMappingURL=site-rmstvecm.js.map
