...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=s;var Qe={name:e,shader:s};var t="bonesVertex",d=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=d;var Xe={name:t,shader:d};var r="bakedVertexAnimationDeclaration",m=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=m;var qe={name:r,shader:m};var n="instancesDeclaration",o=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=o;var Ue={name:n,shader:o};var a="instancesVertex",u=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=u;var Ne={name:a,shader:u};var f="bakedVertexAnimation",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=c;var $e={name:f,shader:c};
export{Qe,qe,Ue,Ne,Xe,$e};

//# debugId=A878D6FD807AAF2B64756E2164756E21
//# sourceMappingURL=site-e0ybn2qx.js.map
