import{te}from"./site-ybnjbk1z.js";import{$t,qt,Ti}from"./site-hsewys6t.js";import{Ri}from"./site-t1e923cw.js";import{xe,ve}from"./site-t5na8t3j.js";import{W}from"./site-6bak08eg.js";import{tt,Ye}from"./site-m1s81bf3.js";import{ai}from"./site-ndpmtms5.js";import{We}from"./site-cr62e97z.js";import{Mi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="terrainPixelShader",f=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=f;var a=[te,$t,Ri,qt,xe,W,tt,ve,Ti,ai,We,Ye,Mi];for(let e of a)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var b={name:r,shader:f};export{b as terrainPixelShaderWGSL};

//# debugId=38FDE3DAD8384AED64756E2164756E21
//# sourceMappingURL=terrain.fragment-wd20a7br.js.map
