...
`;if(!j.ShadersStoreWGSL[w])j.ShadersStoreWGSL[w]=Z;var _=[y,z,H,B,U,E,R,T,I,J,K,N,O,X,Q,Y];for(let q of _)if(!j.IncludesShadersStoreWGSL[q.name])j.IncludesShadersStoreWGSL[q.name]=q.shader;var V={name:w,shader:Z};export{V as lavaVertexShaderWGSL};

//# debugId=3A9F1474AE3F735B64756E2164756E21
//# sourceMappingURL=lava.vertex-y8spdn3k.js.map
