...
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=A;var b={name:r,shader:A};var t="openpbrNormalMapFragmentMainFunctions",N=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=N;var F={name:t,shader:N};var n="openpbrNormalMapFragmentFunctions",L=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=L;var D={name:n,shader:L};var a="openpbrConductorReflectance",O=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=O;var C={name:a,shader:O};var s="openpbrAmbientOcclusionFunctions",P=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;if(!i.IncludesShadersStore[s])i.IncludesShadersStore[s]=P;var M={name:s,shader:P};var c="openpbrVolumeFunctions",x=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;if(!i.IncludesShadersStore[c])i.IncludesShadersStore[c]=x;var G={name:c,shader:x};var f="openpbrNormalMapFragment",y=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;if(!i.IncludesShadersStore[f])i.IncludesShadersStore[f]=y;var z={name:f,shader:y};var l="openpbrBlockNormalFinal",U=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;if(!i.IncludesShadersStore[_])i.IncludesShadersStore[_]=w;var W={name:_,shader:w};var d="openpbrCoatLayerData",H=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;if(!i.IncludesShadersStore[d])i.IncludesShadersStore[d]=H;var B={name:d,shader:H};var m="openpbrThinFilmLayerData",V=`#ifdef THIN_FILM
...
#endif
`;if(!i.IncludesShadersStore[m])i.IncludesShadersStore[m]=V;var k={name:m,shader:V};var u="openpbrFuzzLayerData",Z=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;if(!i.IncludesShadersStore[u])i.IncludesShadersStore[u]=Z;var j={name:u,shader:Z};var g="openpbrAmbientOcclusionData",q=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;if(!i.IncludesShadersStore[g])i.IncludesShadersStore[g]=q;var K={name:g,shader:q};var p="openpbrBackgroundTransmission",Q=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;if(!i.IncludesShadersStore[p])i.IncludesShadersStore[p]=Q;var J={name:p,shader:Q};var E="openpbrEnvironmentLighting",ee=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;if(!i.IncludesShadersStore[E])i.IncludesShadersStore[E]=ee;var oe={name:E,shader:ee};var v="openpbrDirectLightingInit",ie=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!i.IncludesShadersStore[v])i.IncludesShadersStore[v]=ie;var re={name:v,shader:ie};var h="openpbrDirectLighting",te=`#ifdef LIGHT{X}
...
#endif
`;if(!i.IncludesShadersStore[h])i.IncludesShadersStore[h]=te;var ne={name:h,shader:te};var R="openpbrBlockPrePass",ae=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!i.IncludesShadersStore[R])i.IncludesShadersStore[R]=ae;var ce={name:R,shader:ae};var I="openpbrPixelShader",fe=`#define OPENPBR_FRAGMENT_SHADER
...
`;if(!i.ShadersStore[I])i.ShadersStore[I]=fe;var le=[Ul,Wl,ta,zl,T,Rt,nr,hf,Us,yf,Ie,Pe,Ka,wl,b,ls,Me,Y,rt,Hl,se,Ml,sa,Tf,cs,Jt,fn,Da,Cf,Ef,Fr,na,Af,Dl,F,D,tn,af,C,M,of,lf,G,Ee,Rf,z,X,W,uf,cf,B,k,j,K,Mi,J,oe,re,ne,it,ot,If,ce,Xl,Pf];for(let e of le)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var KT={name:I,shader:fe};
export{KT};

//# debugId=1F6D87C3E70218D164756E2164756E21
//# sourceMappingURL=site-ezmqykx8.js.map
