import{DD as e}from"./site-53d1aqt6.js";var t="pbrFragmentExtraDeclaration",c=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;if(!e.IncludesShadersStore[t])e.IncludesShadersStore[t]=c;var C={name:t,shader:c};var o="pbrHelperFunctions",s=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!e.IncludesShadersStore[o])e.IncludesShadersStore[o]=s;var m={name:o,shader:s};var i="pbrDirectLightingSetupFunctions",d=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;if(!e.IncludesShadersStore[i])e.IncludesShadersStore[i]=d;var S={name:i,shader:d};var r="pbrDirectLightingFalloffFunctions",g=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;if(!e.IncludesShadersStore[r])e.IncludesShadersStore[r]=g;var F={name:r,shader:g};var a="pbrDirectLightingFunctions",u=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;if(!e.IncludesShadersStore[a])e.IncludesShadersStore[a]=u;var _={name:a,shader:u};var l="pbrBlockNormalGeometric",E=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;if(!e.IncludesShadersStore[l])e.IncludesShadersStore[l]=E;var U={name:l,shader:E};var n="pbrBlockImageProcessing",h=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!e.IncludesShadersStore[n])e.IncludesShadersStore[n]=h;var P={name:n,shader:h};var f="pbrDebug",D=`#if DEBUGMODE>0
...
#endif
`;if(!e.IncludesShadersStore[f])e.IncludesShadersStore[f]=D;var W={name:f,shader:D};
export{C as aj,m as bj,S as cj,F as dj,_ as ej,U as fj,P as gj,W as hj};

//# debugId=4016DFF012DE110C64756E2164756E21
//# sourceMappingURL=site-9c6dd7hc.js.map
