import{i}from"./site-1yf4ncc8.js";var e="lightFragmentDeclaration",h=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=h;var Ce={name:e,shader:h};var t="lightUboDeclaration",p=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=p;var Ee={name:t,shader:p};var o="shadowsFragmentFunctions",u=`#ifdef SHADOWS
...
#endif
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=u;var Xt={name:o,shader:u};var r="imageProcessingDeclaration",m=`#ifdef EXPOSURE
...
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=m;var Wr={name:r,shader:m};var a="imageProcessingFunctions",S=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=S;var Hr={name:a,shader:S};var s="decalFragmentDeclaration",g=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;if(!i.IncludesShadersStore[s])i.IncludesShadersStore[s]=g;var Qo={name:s,shader:g};var c="prePassDeclaration",x=`#ifdef PREPASS
...
#endif
#endif
`;if(!i.IncludesShadersStore[c])i.IncludesShadersStore[c]=x;var Ko={name:c,shader:x};var l="oitDeclaration",w=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;if(!i.IncludesShadersStore[v])i.IncludesShadersStore[v]=D;var ea={name:v,shader:D};var d="textureRepetitionFunctions",T=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!i.IncludesShadersStore[d])i.IncludesShadersStore[d]=T;var Jo={name:d,shader:T};var n="depthPrePass",E=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=E;var yi={name:n,shader:E};var f="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!i.IncludesShadersStore[f])i.IncludesShadersStore[f]=C;var el={name:f,shader:C};
export{Qo,Ko,Zo,Ce,Ee,ea,Xt,Wr,Hr,Jo,yi,el};

//# debugId=408D33D88163EFB164756E2164756E21
//# sourceMappingURL=site-b1m3rnst.js.map
