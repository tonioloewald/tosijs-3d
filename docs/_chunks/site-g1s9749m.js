import{i}from"./site-1yf4ncc8.js";var e="gaussianSplatting",t=`fn getDataUV(index: f32,dataTextureSize: vec2f)->vec2<f32> {let y: f32=floor(index/dataTextureSize.x);let x: f32=index-y*dataTextureSize.x;return vec2f((x+0.5),(y+0.5));}
...
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=t;var Va={name:e,shader:t};
export{Va};

//# debugId=B23320DDF6DFE80F64756E2164756E21
//# sourceMappingURL=site-g1s9749m.js.map
