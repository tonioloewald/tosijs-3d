...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=v;var ei={name:e,shader:v};var t="shadowsVertex",l=`#ifdef SHADOWS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=l;var ti={name:t,shader:l};var r="uvAttributeDeclaration",p=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=p;var $l={name:r,shader:p};var f="prePassVertexDeclaration",c=`#ifdef PREPASS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=c;var jl={name:f,shader:c};var a="samplerVertexDeclaration",_=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=_;var Ql={name:a,shader:_};var n="vertexPullingDeclaration",x=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=x;var Ja={name:n,shader:x};var o="vertexPullingVertex",m=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=m;var ql={name:o,shader:m};var d="prePassVertex",V=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=V;var Zl={name:d,shader:V};var s="uvVariableDeclaration",E=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=E;var Kl={name:s,shader:E};var u="samplerVertexImplementation",I=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=I;var Jl={name:u,shader:I};
export{$l,jl,Ql,ei,Ja,ql,Zl,Kl,Jl,ti};

//# debugId=63176812B3E3E81D64756E2164756E21
//# sourceMappingURL=site-jev74p6a.js.map
