import{Xi as c}from"./site-nb7bnawr.js";import{Nz as s}from"./site-apq8y78s.js";import{DD as e}from"./site-53d1aqt6.js";import"./site-0m1fh7vm.js";var t="fibonacci",a=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=a;var l={name:t,shader:a};var i="diffusionProfile",f=`uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;if(!e.IncludesShadersStoreWGSL[i])e.IncludesShadersStoreWGSL[i]=f;var o={name:i,shader:f};var n="subSurfaceScatteringPixelShader",u=`#include<helperFunctions>
#include<fibonacci>
...
`;if(!e.ShadersStoreWGSL[n])e.ShadersStoreWGSL[n]=u;var S=[s,l,c,o];for(let r of S)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var I={name:n,shader:u};export{I as subSurfaceScatteringPixelShaderWGSL};

//# debugId=0C309E99EB330BD564756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-1k4fjb06.js.map
