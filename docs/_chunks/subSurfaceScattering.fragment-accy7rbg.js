import{ij as s}from"./site-4g0shfq3.js";import{Fz as f}from"./site-4grmvsrj.js";import{DD as e}from"./site-53d1aqt6.js";import"./site-0m1fh7vm.js";var i="fibonacci",a=`#define rcp(x) 1./x
#define GOLDEN_RATIO 1.618033988749895
vec2 Golden2dSeq(int i,float n)
{return vec2(float(i)/n+(0.5/n),fract(float(i)*rcp(GOLDEN_RATIO)));}
vec2 SampleDiskGolden(int i,int sampleCount)
{vec2 f=Golden2dSeq(i,float(sampleCount));return vec2(sqrt(f.x),TWO_PI*f.y);}`;if(!e.IncludesShadersStore[i])e.IncludesShadersStore[i]=a;var n={name:i,shader:a};var t="diffusionProfile",l="uniform vec3 diffusionS[5];uniform float diffusionD[5];uniform float filterRadii[5];";if(!e.IncludesShadersStore[t])e.IncludesShadersStore[t]=l;var c={name:t,shader:l};var o="subSurfaceScatteringPixelShader",S=`#include<helperFunctions>
#include<fibonacci>
...
totalWeight=max(totalWeight,HALF_MIN);gl_FragColor=vec4(inputColor.rgb+albedo*max(totalIrradiance/totalWeight,vec3(0.0)),1.);}`;if(!e.ShadersStore[o])e.ShadersStore[o]=S;var d=[f,n,s,c];for(let r of d)if(!e.IncludesShadersStore[r.name])e.IncludesShadersStore[r.name]=r.shader;var D={name:o,shader:S};export{D as subSurfaceScatteringPixelShader};

//# debugId=C3C47EE0847C577D64756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-accy7rbg.js.map
