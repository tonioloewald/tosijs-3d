import{i}from"./site-1yf4ncc8.js";var e="morphTargetsVertexGlobalDeclaration",o=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=o;var Vi={name:e,shader:o};var r="morphTargetsVertexDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=f;var Gi={name:r,shader:f};var t="morphTargetsVertexGlobal",d=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=d;var zi={name:t,shader:d};var n="morphTargetsVertex",T=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=T;var Ui={name:n,shader:T};
export{Vi,Gi,zi,Ui};

//# debugId=A75E3A2652AA4F8A64756E2164756E21
//# sourceMappingURL=site-fw4kkhv7.js.map
