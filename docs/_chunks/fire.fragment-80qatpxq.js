import{xe,ve}from"./site-t5na8t3j.js";import{W}from"./site-6bak08eg.js";import{tt,Ye}from"./site-m1s81bf3.js";import{Ti}from"./site-hsewys6t.js";import{We}from"./site-cr62e97z.js";import{Mi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="firePixelShader",o=`uniform vEyePosition: vec4f;varying vPositionW: vec3f;
#ifdef VERTEXCOLOR
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=o;var t=[xe,W,tt,ve,Ti,We,Ye,Mi];for(let e of t)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var c={name:r,shader:o};export{c as firePixelShaderWGSL};

//# debugId=512A88E91EEADE7864756E2164756E21
//# sourceMappingURL=fire.fragment-80qatpxq.js.map
