import{_B as e}from"./site-ea0e8ybd.js";var t="pbrFragmentExtraDeclaration",s=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=s;var A={name:t,shader:s};var i="pbrHelperFunctions",d=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!e.IncludesShadersStoreWGSL[i])e.IncludesShadersStoreWGSL[i]=d;var O={name:i,shader:d};var r="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;if(!e.IncludesShadersStoreWGSL[r])e.IncludesShadersStoreWGSL[r]=u;var I={name:r,shader:u};var o="pbrDirectLightingFalloffFunctions",g=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;if(!e.IncludesShadersStoreWGSL[o])e.IncludesShadersStoreWGSL[o]=g;var B={name:o,shader:g};var f="pbrBlockReflectance0",h=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=h;var _={name:f,shader:h};var n="pbrDirectLightingFunctions",E=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;if(!e.IncludesShadersStoreWGSL[n])e.IncludesShadersStoreWGSL[n]=E;var H={name:n,shader:E};var a="pbrBlockNormalGeometric",v=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;if(!e.IncludesShadersStoreWGSL[a])e.IncludesShadersStoreWGSL[a]=v;var k={name:a,shader:v};var l="pbrBlockImageProcessing",p=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[l])e.IncludesShadersStoreWGSL[l]=p;var w={name:l,shader:p};var c="pbrDebug",L=`#if DEBUGMODE>0
...
#endif
`;if(!e.IncludesShadersStoreWGSL[c])e.IncludesShadersStoreWGSL[c]=L;var K={name:c,shader:L};
export{A as ij,O as jj,I as kj,B as lj,_ as mj,H as nj,k as oj,w as pj,K as qj};

//# debugId=6283CAEA563330C164756E2164756E21
//# sourceMappingURL=site-6as6w5kv.js.map
