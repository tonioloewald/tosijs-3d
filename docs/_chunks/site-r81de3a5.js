import{i}from"./site-1yf4ncc8.js";var e="lightUboDeclaration",u=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=u;var ii={name:e,shader:u};var r="shadowsFragmentFunctions",l=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=l;var ri={name:r,shader:l};var t="imageProcessingDeclaration",n=`#ifdef EXPOSURE
...
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=n;var Jr={name:t,shader:n};var a="imageProcessingFunctions",h=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=h;var es={name:a,shader:h};var o="prePassDeclaration",m=`#ifdef PREPASS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=m;var tc={name:o,shader:m};var f="oitDeclaration",S=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=S;var ic={name:f,shader:S};var v="ltcHelperFunctions",x=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;if(!i.IncludesShadersStoreWGSL[v])i.IncludesShadersStoreWGSL[v]=x;var La={name:v,shader:x};var s="clusteredLightingFunctions",w=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=w;var Vn={name:s,shader:w};var c="textureRepetitionFunctions",g=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!i.IncludesShadersStoreWGSL[c])i.IncludesShadersStoreWGSL[c]=g;var rc={name:c,shader:g};var d="depthPrePass",T=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=T;var wi={name:d,shader:T};var p="oitFragment",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!i.IncludesShadersStoreWGSL[p])i.IncludesShadersStoreWGSL[p]=y;var sc={name:p,shader:y};
export{tc,ic,ii,La,Vn,ri,Jr,es,rc,wi,sc};

//# debugId=40A92FA14540933A64756E2164756E21
//# sourceMappingURL=site-r81de3a5.js.map
