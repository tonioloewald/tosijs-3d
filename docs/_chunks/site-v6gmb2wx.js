import{Nz as i}from"./site-apq8y78s.js";import{DD as e}from"./site-53d1aqt6.js";var r="iblShadowVoxelTracingPixelShader",t=`varying vUV: vec2f;
...
#endif
#endif
}`;if(!e.ShadersStoreWGSL[r])e.ShadersStoreWGSL[r]=t;var s=[i];for(let a of s)if(!e.IncludesShadersStoreWGSL[a.name])e.IncludesShadersStoreWGSL[a.name]=a.shader;var f={name:r,shader:t};
export{f as Mi};

//# debugId=5EF0C88955A7ECDE64756E2164756E21
//# sourceMappingURL=site-v6gmb2wx.js.map
