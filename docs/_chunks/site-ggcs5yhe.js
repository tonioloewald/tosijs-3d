...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=o;var Qi={name:e,shader:o};var r="morphTargetsVertexDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=f;var qi={name:r,shader:f};var t="morphTargetsVertexGlobal",d=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
...
#endif
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=T;var Ki={name:n,shader:T};
export{Qi,qi,Zi,Ki};

//# debugId=2A2B48D1D5B1090964756E2164756E21
//# sourceMappingURL=site-ggcs5yhe.js.map
