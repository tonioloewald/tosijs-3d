import{nk as o}from"./site-t7c91zba.js";import{ok as f}from"./site-yqes9c3t.js";import{Nz as i}from"./site-apq8y78s.js";import{DD as e}from"./site-53d1aqt6.js";var t="screenSpaceReflection2PixelShader",n=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;if(!e.ShadersStoreWGSL[t])e.ShadersStoreWGSL[t]=n;var a=[i,f,o];for(let r of a)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var v={name:t,shader:n};
export{v as ik};

//# debugId=8A1E9D9CF7318D1664756E2164756E21
//# sourceMappingURL=site-vdqs8jj0.js.map
