import{xt}from"./site-23zackra.js";import{Di}from"./site-v7w00mev.js";import{ih}from"./site-t5qgb0ss.js";import{il,rl,sl,Yt,ba,nl,al,ol,ll,jt}from"./site-1zb20hn6.js";import{vs}from"./site-h8pshetj.js";import{te}from"./site-ybnjbk1z.js";import{xr}from"./site-jqf0yjpr.js";import{He,Xe,Be,Me,Ge,Ue}from"./site-sfve3vze.js";import{Gs}from"./site-386yabfx.js";import{_e,ge}from"./site-2pb4jqv9.js";import{rt,ot}from"./site-qfh4aa45.js";import{Zi,Ji,nr,ar}from"./site-3s4ms0e1.js";import{W}from"./site-6bak08eg.js";import{oi}from"./site-w3wmtc5w.js";import{Je}from"./site-p3sjwtn5.js";import{i}from"./site-1yf4ncc8.js";var r="openpbrNormalMapVertexDeclaration",o=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
...
}`;if(!i.ShadersStoreWGSL[n])i.ShadersStoreWGSL[n]=N;var s=[xt,Di,ih,il,vs,te,xr,He,Xe,Be,rl,sl,Gs,a,_e,rt,Yt,Zi,Ji,W,ba,nl,nr,ar,Me,Ge,Ue,al,ol,ll,_,ge,ot,jt,oi,Je];for(let e of s)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var ET={name:n,shader:N};
export{ET};

//# debugId=1A422D4FAE42190C64756E2164756E21
//# sourceMappingURL=site-xf6gxerr.js.map
