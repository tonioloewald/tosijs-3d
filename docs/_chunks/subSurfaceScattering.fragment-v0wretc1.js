import{te}from"./site-ybnjbk1z.js";import{Bo}from"./site-b92dzefk.js";import{i}from"./site-1yf4ncc8.js";var r="fibonacci",a=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;if(!i.ShadersStoreWGSL[n])i.ShadersStoreWGSL[n]=s;var c=[te,l,Bo,o];for(let e of c)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var g={name:n,shader:s};export{g as subSurfaceScatteringPixelShaderWGSL};

//# debugId=0A7C66E662740E1764756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-v0wretc1.js.map
