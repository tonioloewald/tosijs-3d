import{i}from"./site-1yf4ncc8.js";var e="gaussianSplattingVertexDeclaration",s="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=s;var Co={name:e,shader:s};var t="gaussianSplatting",o=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=o;var Eo={name:t,shader:o};var a="gaussianSplattingUboDeclaration",c=`#include<sceneUboDeclaration>
...
`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=c;var Yl={name:a,shader:c};
export{Co,Yl,Eo};

//# debugId=1CBF98FD01B0C96C64756E2164756E21
//# sourceMappingURL=site-9hv2gc9y.js.map
