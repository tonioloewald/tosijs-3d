import{be,Se}from"./site-v5nrt80s.js";import{lt,ft}from"./site-1fnr94jv.js";import{X}from"./site-vka3s0eg.js";import{st}from"./site-gbqy22ka.js";import{i}from"./site-1yf4ncc8.js";var t="gpuRenderParticlesVertexShader",r=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;if(!i.ShadersStoreWGSL[t])i.ShadersStoreWGSL[t]=r;var o=[be,lt,X,Se,ft,st];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var c={name:t,shader:r};export{c as gpuRenderParticlesVertexShaderWGSL};

//# debugId=17E6560E02BBFDBD64756E2164756E21
//# sourceMappingURL=gpuRenderParticles.vertex-v1gqhkk8.js.map
