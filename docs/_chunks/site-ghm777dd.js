import{DD as e}from"./site-53d1aqt6.js";var t="decalFragmentDeclaration",d=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;if(!e.IncludesShadersStore[t])e.IncludesShadersStore[t]=d;var l={name:t,shader:d};var r="prePassDeclaration",v=`#ifdef PREPASS
...
#endif
#endif
`;if(!e.IncludesShadersStore[r])e.IncludesShadersStore[r]=v;var u={name:r,shader:v};var o="oitDeclaration",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;if(!e.IncludesShadersStore[o])e.IncludesShadersStore[o]=f;var T={name:o,shader:f};var a="textureRepetitionFunctions",i=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!e.IncludesShadersStore[a])e.IncludesShadersStore[a]=i;var m={name:a,shader:i};var c="oitFragment",s=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!e.IncludesShadersStore[c])e.IncludesShadersStore[c]=s;var g={name:c,shader:s};
export{l as mz,u as nz,T as oz,m as pz,g as qz};

//# debugId=FB985DF806F08C9464756E2164756E21
//# sourceMappingURL=site-ghm777dd.js.map
