import{tc,ic,ii,La,Vn,ri,Jr,es,rc,wi,sc}from"./site-r81de3a5.js";import{Ct}from"./site-czf9pgne.js";import{Ui}from"./site-egwk4kn6.js";import{nf}from"./site-928p0qq6.js";import{zs}from"./site-xq5t51ez.js";import{ff,Il,ia,df,pf,mf,ra,_f,gf,xf,vf,bf}from"./site-xt85vzwg.js";import{ro,rn}from"./site-kd1tj1ge.js";import{Pl,Ol}from"./site-xnj3gg1x.js";import{ye,Te}from"./site-h1rvyaww.js";import{X}from"./site-vka3s0eg.js";import{at,Ze}from"./site-z38ag2pz.js";import{re}from"./site-k4eckz4x.js";import{dn}from"./site-2xgs12a3.js";import{Nr}from"./site-cbsxjzzp.js";import{Jh,ef,tf,rf,sf}from"./site-r6fkzck5.js";import{je}from"./site-ybj3mbc4.js";import{i}from"./site-1yf4ncc8.js";var r="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=I;var R={name:r,shader:I};var t="openpbrNormalMapFragmentMainFunctions",b=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=b;var N={name:t,shader:b};var a="openpbrNormalMapFragmentFunctions",T=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=T;var L={name:a,shader:T};var o="openpbrConductorReflectance",A=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=A;var F={name:o,shader:A};var n="openpbrAmbientOcclusionFunctions",D=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=D;var O={name:n,shader:D};var f="openpbrVolumeFunctions",C=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=C;var G={name:f,shader:C};var s="openpbrNormalMapFragment",P=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=P;var x={name:s,shader:P};var l="openpbrBlockNormalFinal",M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[m])i.IncludesShadersStoreWGSL[m]=U;var w={name:m,shader:U};var _="openpbrThinFilmLayerData",H=`#ifdef THIN_FILM
...
#endif
`;if(!i.IncludesShadersStoreWGSL[_])i.IncludesShadersStoreWGSL[_]=H;var B={name:_,shader:H};var d="openpbrFuzzLayerData",V=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=V;var k={name:d,shader:V};var u="openpbrAmbientOcclusionData",Y=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=Y;var Z={name:u,shader:Y};var p="openpbrBackgroundTransmission",j=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;if(!i.IncludesShadersStoreWGSL[p])i.IncludesShadersStoreWGSL[p]=j;var q={name:p,shader:j};var g="openpbrEnvironmentLighting",K=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[g])i.IncludesShadersStoreWGSL[g]=K;var Q={name:g,shader:K};var v="openpbrDirectLightingInit",J=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[v])i.IncludesShadersStoreWGSL[v]=J;var ee={name:v,shader:J};var S="openpbrDirectLighting",te=`#ifdef LIGHT{X}
...
#endif
`;if(!i.IncludesShadersStoreWGSL[S])i.IncludesShadersStoreWGSL[S]=te;var ae={name:S,shader:te};var E="openpbrBlockPrePass",ie=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[E])i.IncludesShadersStoreWGSL[E]=ie;var oe={name:E,shader:ie};var h="openpbrPixelShader",ne=`#define OPENPBR_FRAGMENT_SHADER
...
`;if(!i.ShadersStoreWGSL[h])i.ShadersStoreWGSL[h]=ne;var fe=[tc,ic,Ct,Ui,nf,zs,ff,ii,ro,Pl,R,Jr,ye,X,at,rc,re,Il,ia,df,es,ri,dn,La,pf,mf,Nr,ra,Vn,_f,gf,Ol,N,L,rn,Jh,F,O,ef,tf,G,Te,xf,x,W,z,sf,rf,w,B,k,Z,wi,q,Q,ee,ae,je,Ze,vf,oe,sc,bf];for(let e of fe)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var qT={name:h,shader:ne};
export{qT};

//# debugId=F61610CF4B3364C164756E2164756E21
//# sourceMappingURL=site-nc1rp038.js.map
