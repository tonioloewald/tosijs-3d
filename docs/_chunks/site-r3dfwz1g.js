import{tc,ic,ii,La,Vn,ri,Jr,es,rc,wi,sc}from"./site-r81de3a5.js";import{Ct}from"./site-czf9pgne.js";import{Ui}from"./site-egwk4kn6.js";import{Sf}from"./site-n36es9d8.js";import{zs}from"./site-xq5t51ez.js";import{ff,Il,ia,df,pf,mf,ra,_f,gf,xf,vf,bf}from"./site-xt85vzwg.js";import{ro,rn}from"./site-kd1tj1ge.js";import{Pl,Ol}from"./site-xnj3gg1x.js";import{ye,Te}from"./site-h1rvyaww.js";import{X}from"./site-vka3s0eg.js";import{at,Ze}from"./site-z38ag2pz.js";import{re}from"./site-k4eckz4x.js";import{dn}from"./site-2xgs12a3.js";import{Nr}from"./site-cbsxjzzp.js";import{eo,to,io}from"./site-6gdpr4z0.js";import{td,pi}from"./site-64n1eeg0.js";import{je}from"./site-ybj3mbc4.js";import{i}from"./site-1yf4ncc8.js";var r="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=T;var L={name:r,shader:T};var a="pbrFragmentSamplersDeclaration",_=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=_;var M={name:a,shader:_};var n="pbrBlockAlbedoOpacity",D=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=D;var F={name:n,shader:D};var f="pbrBlockReflectivity",g=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=g;var P={name:f,shader:g};var o="pbrBlockAmbientOcclusion",h=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=h;var b={name:o,shader:h};var t="pbrBlockAlphaFresnel",U=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=U;var G={name:t,shader:U};var c="pbrBlockAnisotropic",B=`#ifdef ANISOTROPIC
...
#endif
`;if(!i.IncludesShadersStoreWGSL[c])i.IncludesShadersStoreWGSL[c]=B;var y={name:c,shader:B};var l="pbrBlockReflection",W=`#ifdef REFLECTION
...
#endif
`;if(!i.IncludesShadersStoreWGSL[l])i.IncludesShadersStoreWGSL[l]=W;var V={name:l,shader:W};var d="pbrBlockSheen",x=`#ifdef SHEEN
...
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=x;var H={name:d,shader:x};var s="pbrBlockClearcoat",k=`struct clearcoatOutParams
...
return outParams;}
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=k;var Y={name:s,shader:k};var E="pbrBlockIridescence",w=`struct iridescenceOutParams
...
#endif
`;if(!i.IncludesShadersStoreWGSL[E])i.IncludesShadersStoreWGSL[E]=w;var z={name:E,shader:w};var m="pbrBlockSubSurface",K=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;if(!i.IncludesShadersStoreWGSL[m])i.IncludesShadersStoreWGSL[m]=K;var q={name:m,shader:K};var S="pbrBlockNormalFinal",Z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[S])i.IncludesShadersStoreWGSL[S]=Z;var J={name:S,shader:Z};var R="pbrBlockLightmapInit",Q=`#ifdef LIGHTMAP
...
#endif
`;if(!i.IncludesShadersStoreWGSL[R])i.IncludesShadersStoreWGSL[R]=Q;var j={name:R,shader:Q};var C="pbrBlockGeometryInfo",ee=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[C])i.IncludesShadersStoreWGSL[C]=ee;var ie={name:C,shader:ee};var u="pbrBlockReflectance",ae=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=ae;var ne={name:u,shader:ae};var p="pbrBlockDirectLighting",fe=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!i.IncludesShadersStoreWGSL[p])i.IncludesShadersStoreWGSL[p]=fe;var oe={name:p,shader:fe};var v="pbrBlockFinalLitComponents",te=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[v])i.IncludesShadersStoreWGSL[v]=te;var ce={name:v,shader:te};var I="pbrBlockFinalUnlitComponents",le=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!i.IncludesShadersStoreWGSL[I])i.IncludesShadersStoreWGSL[I]=le;var de={name:I,shader:le};var A="pbrBlockFinalColorComposition",se=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!i.IncludesShadersStoreWGSL[A])i.IncludesShadersStoreWGSL[A]=se;var Ee={name:A,shader:se};var N="pbrBlockPrePass",me=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[N])i.IncludesShadersStoreWGSL[N]=me;var Se={name:N,shader:me};var O="pbrPixelShader",Re=`#define PBR_FRAGMENT_SHADER
...
`;if(!i.ShadersStoreWGSL[O])i.ShadersStoreWGSL[O]=Re;var Ce=[tc,ic,Ct,Ui,Sf,zs,ff,ii,ro,L,Pl,M,Jr,ye,X,at,rc,re,Il,ia,df,es,ri,dn,La,pf,mf,Nr,ra,Vn,_f,gf,Ol,eo,to,rn,td,F,P,b,G,y,V,H,Y,z,q,Te,xf,io,J,wi,j,ie,ne,oe,pi,ce,de,Ee,je,Ze,vf,Se,sc,bf];for(let e of Ce)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var eC={name:O,shader:Re};
export{eC};

//# debugId=268097EB51D970CD64756E2164756E21
//# sourceMappingURL=site-r3dfwz1g.js.map
