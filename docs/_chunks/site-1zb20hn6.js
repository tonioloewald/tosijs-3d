import{i}from"./site-1yf4ncc8.js";var e="lightVxUboDeclaration",v=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=v;var Yt={name:e,shader:v};var t="shadowsVertex",l=`#ifdef SHADOWS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=l;var jt={name:t,shader:l};var r="uvAttributeDeclaration",p=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=p;var il={name:r,shader:p};var f="prePassVertexDeclaration",c=`#ifdef PREPASS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=c;var rl={name:f,shader:c};var a="samplerVertexDeclaration",_=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=_;var sl={name:a,shader:_};var n="vertexPullingDeclaration",x=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=x;var ba={name:n,shader:x};var o="vertexPullingVertex",m=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=m;var nl={name:o,shader:m};var d="prePassVertex",V=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=V;var al={name:d,shader:V};var s="uvVariableDeclaration",E=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=E;var ol={name:s,shader:E};var u="samplerVertexImplementation",I=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=I;var ll={name:u,shader:I};
export{il,rl,sl,Yt,ba,nl,al,ol,ll,jt};

//# debugId=52FFAEF9D6437FF364756E2164756E21
//# sourceMappingURL=site-1zb20hn6.js.map
