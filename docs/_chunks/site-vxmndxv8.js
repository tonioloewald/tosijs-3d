import{_B as q}from"./site-1q3afg48.js";var v="pbrFragmentExtraDeclaration",Q=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;if(!q.IncludesShadersStore[v])q.IncludesShadersStore[v]=Q;var G={name:v,shader:Q};var w="pbrHelperFunctions",T=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!q.IncludesShadersStore[w])q.IncludesShadersStore[w]=T;var P={name:w,shader:T};var z="pbrDirectLightingSetupFunctions",W=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;if(!q.IncludesShadersStore[z])q.IncludesShadersStore[z]=W;var H={name:z,shader:W};var A="pbrDirectLightingFalloffFunctions",X=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;if(!q.IncludesShadersStore[A])q.IncludesShadersStore[A]=X;var F={name:A,shader:X};var C="pbrDirectLightingFunctions",Y=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;if(!q.IncludesShadersStore[C])q.IncludesShadersStore[C]=Y;var b={name:C,shader:Y};var J="pbrBlockNormalGeometric",Z=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;if(!q.IncludesShadersStore[J])q.IncludesShadersStore[J]=Z;var l={name:J,shader:Z};var K="pbrBlockImageProcessing",_=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!q.IncludesShadersStore[K])q.IncludesShadersStore[K]=_;var j={name:K,shader:_};var O="pbrDebug",$=`#if DEBUGMODE>0
...
#endif
`;if(!q.IncludesShadersStore[O])q.IncludesShadersStore[O]=$;var p={name:O,shader:$};
export{G as Aj,P as Bj,H as Cj,F as Dj,b as Ej,l as Fj,j as Gj,p as Hj};

//# debugId=DE3F5AC1663FBF7D64756E2164756E21
//# sourceMappingURL=site-vxmndxv8.js.map
