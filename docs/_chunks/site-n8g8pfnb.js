import{DD as e}from"./site-53d1aqt6.js";var r="pbrFragmentReflectionDeclaration",i=`#ifdef REFLECTION
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[r])e.IncludesShadersStoreWGSL[r]=i;var o={name:r,shader:i};var a="pbrIBLFunctions",n=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[a])e.IncludesShadersStoreWGSL[a]=n;var c={name:a,shader:n};
export{o as tj,c as uj};

//# debugId=2450A6B264E1E18664756E2164756E21
//# sourceMappingURL=site-n8g8pfnb.js.map
