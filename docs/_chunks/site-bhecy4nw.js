...
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=c;var ta={name:e,shader:c};var n="openpbrDielectricReflectance",f=`struct ReflectanceParams
...
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=f;var af={name:n,shader:f};var r="openpbrGeometryInfo",s=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=s;var of={name:r,shader:s};var o="openpbrIblFunctions",l=`#ifdef REFLECTION
...
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=m;var uf={name:t,shader:m};
export{ta,af,of,lf,cf,uf};

//# debugId=914366747146981264756E2164756E21
//# sourceMappingURL=site-bhecy4nw.js.map
