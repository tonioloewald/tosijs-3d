import{re}from"./site-k4eckz4x.js";import{ii,ri,wi}from"./site-r81de3a5.js";import{X}from"./site-vka3s0eg.js";import{Fi}from"./site-zpat65w3.js";import{at,Ze}from"./site-z38ag2pz.js";import{ye,Te}from"./site-h1rvyaww.js";import{pi}from"./site-64n1eeg0.js";import{je}from"./site-ybj3mbc4.js";import{Vi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="furPixelShader",f=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;uniform furColor: vec4f;uniform furLength: f32;varying vPositionW: vec3f;varying vfur_length: f32;
#ifdef NORMAL
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=f;var o=[re,ii,X,Fi,ri,at,ye,Te,wi,pi,je,Ze,Vi];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var L={name:r,shader:f};export{L as furPixelShaderWGSL};

//# debugId=D47E17AC9F0DFC6364756E2164756E21
//# sourceMappingURL=fur.fragment-fpvdy906.js.map
