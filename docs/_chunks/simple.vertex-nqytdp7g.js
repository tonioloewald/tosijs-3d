...
`;if(!q.ShadersStore[B])q.ShadersStore[B]=$;var w=[E,G,K,H,W,J,Z,_,L,N,O,Q,Y,R,X,T];for(let z of w)if(!q.IncludesShadersStore[z.name])q.IncludesShadersStore[z.name]=z.shader;var D={name:B,shader:$};export{D as simpleVertexShader};

//# debugId=AAB0EA1EFEEC258964756E2164756E21
//# sourceMappingURL=simple.vertex-nqytdp7g.js.map
