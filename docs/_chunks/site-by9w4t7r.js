...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=d;var we={name:e,shader:d};var t="bonesVertex",f=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=f;var Oe={name:t,shader:f};var r="bakedVertexAnimationDeclaration",o=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=o;var Ne={name:r,shader:o};var n="instancesDeclaration",s=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=s;var ye={name:n,shader:s};var a="instancesVertex",c=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=c;var be={name:a,shader:c};var m="bakedVertexAnimation",E=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;if(!i.IncludesShadersStore[m])i.IncludesShadersStore[m]=E;var Le={name:m,shader:E};
export{we,Ne,ye,be,Oe,Le};

//# debugId=C2B4D7CA2F0338F564756E2164756E21
//# sourceMappingURL=site-by9w4t7r.js.map
