import{i}from"./site-1yf4ncc8.js";var e="reflectionFunction",o=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=o;var rn={name:e,shader:o};var r="samplerFragmentDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=f;var ro={name:r,shader:f};
export{ro,rn};

//# debugId=BABC5EC8AC584F7F64756E2164756E21
//# sourceMappingURL=site-kd1tj1ge.js.map
