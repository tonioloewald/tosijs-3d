...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=d;var Zi={name:e,shader:d};var r="morphTargetsVertexDeclaration",a=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=a;var Ji={name:r,shader:a};var t="morphTargetsVertexGlobal",o=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=o;var nr={name:t,shader:o};var n="morphTargetsVertex",f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=f;var ar={name:n,shader:f};
export{Zi,Ji,nr,ar};

//# debugId=59BA5C6487A70A6E64756E2164756E21
//# sourceMappingURL=site-3s4ms0e1.js.map
