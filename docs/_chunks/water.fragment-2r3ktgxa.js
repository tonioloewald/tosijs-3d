import{re}from"./site-k4eckz4x.js";import{ii,ri,Jr,es}from"./site-r81de3a5.js";import{Fi}from"./site-zpat65w3.js";import{ye,Te}from"./site-h1rvyaww.js";import{X}from"./site-vka3s0eg.js";import{at,Ze}from"./site-z38ag2pz.js";import{pi}from"./site-64n1eeg0.js";import{je}from"./site-ybj3mbc4.js";import{i}from"./site-1yf4ncc8.js";var r="waterPixelShader",o=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=o;var a=[re,Jr,es,ii,Fi,ri,ye,X,at,Te,pi,je,Ze];for(let e of a)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var T={name:r,shader:o};export{T as waterPixelShaderWGSL};

//# debugId=AC0DEBBCA67CA75964756E2164756E21
//# sourceMappingURL=water.fragment-2r3ktgxa.js.map
