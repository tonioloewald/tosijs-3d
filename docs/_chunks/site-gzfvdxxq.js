import{zl,Ul,Wl,Ie,Pe,Da,Jt,ls,cs,Hl,Mi,Xl}from"./site-y589gf4f.js";import{Rt}from"./site-sdr5y55w.js";import{nr}from"./site-j5z8knjd.js";import{Of}from"./site-was1vppw.js";import{Us}from"./site-pwsmfzme.js";import{yf,Ml,sa,Tf,Cf,Ef,na,Af,Rf,If,Pf}from"./site-rmstvecm.js";import{Ka,tn}from"./site-g6x77x7h.js";import{wl,Dl}from"./site-cqwkman4.js";import{Me,Ee}from"./site-qtq2tkrz.js";import{Y}from"./site-kthp3mjc.js";import{rt,ot}from"./site-m57amydx.js";import{se}from"./site-82m1a6bm.js";import{fn}from"./site-xtmz5r22.js";import{Fr}from"./site-817ykrck.js";import{Qa,qa,Za}from"./site-3jdegyzx.js";import{ja,Kf,di}from"./site-zb70qhmv.js";import{it}from"./site-zcgrc802.js";import{i}from"./site-1yf4ncc8.js";var n="pbrFragmentDeclaration",D=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=G;var V={name:t,shader:G};var c="pbrBlockAlphaFresnel",H=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;if(!i.IncludesShadersStore[c])i.IncludesShadersStore[c]=H;var x={name:c,shader:H};var l="pbrBlockAnisotropic",k=`#ifdef ANISOTROPIC
...
#endif
`;if(!i.IncludesShadersStore[l])i.IncludesShadersStore[l]=k;var X={name:l,shader:k};var d="pbrBlockReflection",W=`#ifdef REFLECTION
...
#endif
`;if(!i.IncludesShadersStore[d])i.IncludesShadersStore[d]=W;var w={name:d,shader:W};var s="pbrBlockSheen",K=`#ifdef SHEEN
...
return outParams;}
#endif
`;if(!i.IncludesShadersStore[m])i.IncludesShadersStore[m]=Q;var ee={name:m,shader:Q};var C="pbrBlockReflectance0",ie=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;if(!i.IncludesShadersStore[C])i.IncludesShadersStore[C]=ie;var ne={name:C,shader:ie};var S="pbrClusteredLightingFunctions",ae=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!i.IncludesShadersStore[S])i.IncludesShadersStore[S]=ae;var re={name:S,shader:ae};var u="pbrBlockNormalFinal",oe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!i.IncludesShadersStore[u])i.IncludesShadersStore[u]=oe;var fe={name:u,shader:oe};var A="pbrBlockLightmapInit",te=`#ifdef LIGHTMAP
...
#endif
`;if(!i.IncludesShadersStore[A])i.IncludesShadersStore[A]=te;var ce={name:A,shader:te};var I="pbrBlockGeometryInfo",le=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;if(!i.IncludesShadersStore[I])i.IncludesShadersStore[I]=le;var de={name:I,shader:le};var v="pbrBlockReflectance",Re=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!i.IncludesShadersStore[v])i.IncludesShadersStore[v]=Re;var me={name:v,shader:Re};var T="pbrBlockDirectLighting",Ce=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!i.IncludesShadersStore[T])i.IncludesShadersStore[T]=Ce;var Se={name:T,shader:Ce};var N="pbrBlockFinalLitComponents",ue=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!i.IncludesShadersStore[N])i.IncludesShadersStore[N]=ue;var Ae={name:N,shader:ue};var p="pbrBlockFinalUnlitComponents",ve=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!i.IncludesShadersStore[p])i.IncludesShadersStore[p]=ve;var Te={name:p,shader:ve};var O="pbrBlockFinalColorComposition",Ne=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!i.IncludesShadersStore[O])i.IncludesShadersStore[O]=Ne;var pe={name:O,shader:Ne};var L="pbrBlockPrePass",Oe=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!i.IncludesShadersStore[L])i.IncludesShadersStore[L]=Oe;var Le={name:L,shader:Oe};var _="pbrPixelShader",_e=`#define PBR_FRAGMENT_SHADER
...
`;if(!i.ShadersStore[_])i.ShadersStore[_]=_e;var De=[Ul,Wl,zl,M,Rt,nr,Of,Us,yf,Ie,Pe,Ka,h,wl,P,ls,Me,Y,rt,Hl,se,Ml,sa,Tf,cs,Jt,fn,Da,Cf,Ef,Fr,na,Af,Dl,Qa,qa,tn,Kf,U,B,V,x,X,w,z,q,j,ee,ja,ne,re,Ee,Rf,Za,fe,Mi,ce,de,me,Se,di,Ae,Te,pe,it,ot,If,Le,Xl,Pf];for(let e of De)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var iC={name:_,shader:_e};
export{iC};

//# debugId=EF31EE26F24C210664756E2164756E21
//# sourceMappingURL=site-gzfvdxxq.js.map
