import{_B as r}from"./site-ea0e8ybd.js";var e="ltcHelperFunctions",t=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;if(!r.IncludesShadersStoreWGSL[e])r.IncludesShadersStoreWGSL[e]=t;var c={name:e,shader:t};
export{c as $z};

//# debugId=6D0682FD5C93111C64756E2164756E21
//# sourceMappingURL=site-s8vfkdrs.js.map
