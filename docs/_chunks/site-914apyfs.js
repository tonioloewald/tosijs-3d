import{zl,Ul,Wl,Ie,Pe,Da,Jt,ls,cs,Hl,Mi,Xl}from"./site-y589gf4f.js";import{ja,Kf,di}from"./site-zb70qhmv.js";import{Rt}from"./site-sdr5y55w.js";import{nr}from"./site-j5z8knjd.js";import{sd}from"./site-jpqth6sr.js";import{Us}from"./site-pwsmfzme.js";import{se}from"./site-82m1a6bm.js";import{Ka,tn}from"./site-g6x77x7h.js";import{Qa,qa,Za}from"./site-3jdegyzx.js";import{Me,Ee}from"./site-qtq2tkrz.js";import{Y}from"./site-kthp3mjc.js";import{rt,ot}from"./site-m57amydx.js";import{it}from"./site-zcgrc802.js";import{i}from"./site-1yf4ncc8.js";var o="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=f;var Ni={name:o,shader:f};var r="fresnelFunction",l=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=l;var AC={name:r,shader:l};var t="defaultFragmentDeclaration",a=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;if(!i.ShadersStore[n])i.ShadersStore[n]=s;var d=[zl,c,Rt,nr,sd,Ul,Wl,Us,se,Ie,Pe,Da,ja,Ni,Jt,Ka,AC,tn,ls,cs,Hl,Qa,qa,Me,Y,rt,Ee,Za,Kf,Mi,di,it,ot,Xl];for(let e of d)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var RC={name:n,shader:s};
export{Ni,AC,RC};

//# debugId=13650C9C1A00738764756E2164756E21
//# sourceMappingURL=site-914apyfs.js.map
