...
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=v;var ff={name:e,shader:v};var t="subSurfaceScatteringFunctions",g=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=g;var Il={name:t,shader:g};var r="importanceSampling",p=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=p;var ia={name:r,shader:p};var f="pbrHelperFunctions",h=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=h;var df={name:f,shader:h};var o="pbrDirectLightingSetupFunctions",E=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=E;var pf={name:o,shader:E};var n="pbrDirectLightingFalloffFunctions",L=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=L;var mf={name:n,shader:L};var a="hdrFilteringFunctions",m=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=m;var ra={name:a,shader:m};var l="pbrBlockReflectance0",S=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;if(!i.IncludesShadersStoreWGSL[l])i.IncludesShadersStoreWGSL[l]=S;var _f={name:l,shader:S};var c="pbrDirectLightingFunctions",D=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;if(!i.IncludesShadersStoreWGSL[c])i.IncludesShadersStoreWGSL[c]=D;var gf={name:c,shader:D};var s="pbrBlockNormalGeometric",A=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=A;var xf={name:s,shader:A};var d="pbrBlockImageProcessing",T=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=T;var vf={name:d,shader:T};var u="pbrDebug",N=`#if DEBUGMODE>0
...
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=N;var bf={name:u,shader:N};
export{ff,Il,ia,df,pf,mf,ra,_f,gf,xf,vf,bf};

//# debugId=78DDEE8E42F47E6864756E2164756E21
//# sourceMappingURL=site-xt85vzwg.js.map
