import{_B as q}from"./site-1q3afg48.js";var v="pbrFragmentExtraDeclaration",T=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;if(!q.IncludesShadersStoreWGSL[v])q.IncludesShadersStoreWGSL[v]=T;var N={name:v,shader:T};var w="pbrHelperFunctions",W=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!q.IncludesShadersStoreWGSL[w])q.IncludesShadersStoreWGSL[w]=W;var V={name:w,shader:W};var z="pbrDirectLightingSetupFunctions",X=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;if(!q.IncludesShadersStoreWGSL[z])q.IncludesShadersStoreWGSL[z]=X;var D={name:z,shader:X};var A="pbrDirectLightingFalloffFunctions",Y=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;if(!q.IncludesShadersStoreWGSL[A])q.IncludesShadersStoreWGSL[A]=Y;var E={name:A,shader:Y};var C="pbrBlockReflectance0",Z=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;if(!q.IncludesShadersStoreWGSL[C])q.IncludesShadersStoreWGSL[C]=Z;var R={name:C,shader:Z};var J="pbrDirectLightingFunctions",_=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;if(!q.IncludesShadersStoreWGSL[J])q.IncludesShadersStoreWGSL[J]=_;var g={name:J,shader:_};var K="pbrBlockNormalGeometric",$=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;if(!q.IncludesShadersStoreWGSL[K])q.IncludesShadersStoreWGSL[K]=$;var i={name:K,shader:$};var O="pbrBlockImageProcessing",x=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!q.IncludesShadersStoreWGSL[O])q.IncludesShadersStoreWGSL[O]=x;var S={name:O,shader:x};var Q="pbrDebug",y=`#if DEBUGMODE>0
...
#endif
`;if(!q.IncludesShadersStoreWGSL[Q])q.IncludesShadersStoreWGSL[Q]=y;var o={name:Q,shader:y};
export{N as ij,V as jj,D as kj,E as lj,R as mj,g as nj,i as oj,S as pj,o as qj};

//# debugId=BF58EA2AAE98B73164756E2164756E21
//# sourceMappingURL=site-7zm2vj66.js.map
