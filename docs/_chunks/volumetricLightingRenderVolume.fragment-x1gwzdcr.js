import{xt}from"./site-23zackra.js";import{Di}from"./site-v7w00mev.js";import{i}from"./site-1yf4ncc8.js";var t="volumetricLightingRenderVolumePixelShader",n=`#include<sceneUboDeclaration>
...
`;if(!i.ShadersStoreWGSL[t])i.ShadersStoreWGSL[t]=n;var r=[xt,Di];for(let e of r)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var a={name:t,shader:n};export{a as volumetricLightingRenderVolumePixelShaderWGSL};

//# debugId=C87AC2C42904707564756E2164756E21
//# sourceMappingURL=volumetricLightingRenderVolume.fragment-x1gwzdcr.js.map
