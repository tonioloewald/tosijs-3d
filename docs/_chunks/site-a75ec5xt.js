import{i}from"./site-1yf4ncc8.js";var e="pbrFragmentReflectionDeclaration",a=`#ifdef REFLECTION
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=a;var ko={name:e,shader:a};var r="pbrIBLFunctions",n=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=n;var Vo={name:r,shader:n};
export{ko,Vo};

//# debugId=3B7FDBDA2F3D524164756E2164756E21
//# sourceMappingURL=site-a75ec5xt.js.map
