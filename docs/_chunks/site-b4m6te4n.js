import{DD as e}from"./site-53d1aqt6.js";var r="bilateralBlurPixelShader",o=`uniform sampler2D textureSampler;uniform sampler2D depthSampler;uniform sampler2D normalSampler;uniform int filterSize;uniform vec2 blurDir;uniform float depthThreshold;uniform float normalThreshold;varying vec2 vUV;void main(void) {vec3 color=textureLod(textureSampler,vUV,0.).rgb;float depth=textureLod(depthSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(color,1.);return;}
...
//# debugId=673152140734852F64756E2164756E21
//# sourceMappingURL=site-b4m6te4n.js.map
