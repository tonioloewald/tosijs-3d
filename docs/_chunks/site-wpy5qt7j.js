import{_B as e}from"./site-ea0e8ybd.js";var r="openpbrDielectricReflectance",a=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;if(!e.IncludesShadersStoreWGSL[r])e.IncludesShadersStoreWGSL[r]=a;var m={name:r,shader:a};var n="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;if(!e.IncludesShadersStoreWGSL[n])e.IncludesShadersStoreWGSL[n]=t;var v={name:n,shader:t};var i="openpbrIblFunctions",c=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=l;var _={name:f,shader:l};
export{m as Qi,v as Ri,R as Si,L as Ti,_ as Ui};

//# debugId=18F9D9E2D3F838E464756E2164756E21
//# sourceMappingURL=site-wpy5qt7j.js.map
