import{DD as r}from"./site-53d1aqt6.js";var e="bilateralBlurQualityPixelShader",o=`uniform sampler2D textureSampler;uniform sampler2D depthSampler;uniform sampler2D normalSampler;uniform int filterSize;uniform vec2 blurDir;uniform float depthThreshold;uniform float normalThreshold;varying vec2 vUV;void main(void) {vec3 color=textureLod(textureSampler,vUV,0.).rgb;float depth=textureLod(depthSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(color,1.);return;}
...
`;if(!r.ShadersStore[e])r.ShadersStore[e]=o;var l={name:e,shader:o};
export{l as ng};

//# debugId=29C36DE7F77E1CB364756E2164756E21
//# sourceMappingURL=site-ty8ssaza.js.map
