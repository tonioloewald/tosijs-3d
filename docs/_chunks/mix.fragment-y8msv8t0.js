import{re}from"./site-k4eckz4x.js";import{ii,ri,wi}from"./site-r81de3a5.js";import{Fi}from"./site-zpat65w3.js";import{ye,Te}from"./site-h1rvyaww.js";import{X}from"./site-vka3s0eg.js";import{at,Ze}from"./site-z38ag2pz.js";import{pi}from"./site-64n1eeg0.js";import{je}from"./site-ybj3mbc4.js";import{Vi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var f="mixPixelShader",r=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;if(!i.ShadersStoreWGSL[f])i.ShadersStoreWGSL[f]=r;var o=[re,ii,Fi,ri,ye,X,at,Te,wi,pi,je,Ze,Vi];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var x={name:f,shader:r};export{x as mixPixelShaderWGSL};

//# debugId=30851EB74F812D5F64756E2164756E21
//# sourceMappingURL=mix.fragment-y8msv8t0.js.map
