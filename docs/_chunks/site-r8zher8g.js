import{ul,hl,$t,ta,hn,qt,Lr,Fr,fl,Ti,dl}from"./site-hsewys6t.js";import{xt}from"./site-23zackra.js";import{Di}from"./site-v7w00mev.js";import{ih}from"./site-t5qgb0ss.js";import{vs}from"./site-h8pshetj.js";import{ch,Bo,Cn,uh,hh,fh,En,dh,ph,mh,_h,gh}from"./site-b92dzefk.js";import{Ca,ws}from"./site-vx9qbk6e.js";import{ko,Vo}from"./site-a75ec5xt.js";import{xe,ve}from"./site-t5na8t3j.js";import{W}from"./site-6bak08eg.js";import{tt,Ye}from"./site-m1s81bf3.js";import{te}from"./site-ybnjbk1z.js";import{Gs}from"./site-386yabfx.js";import{xr}from"./site-jqf0yjpr.js";import{Ku,Zu,Ju,eh,th}from"./site-wn35mznw.js";import{We}from"./site-cr62e97z.js";import{i}from"./site-1yf4ncc8.js";var r="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[l])i.IncludesShadersStoreWGSL[l]=M;var y={name:l,shader:M};var c="openpbrBaseLayerData",z=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;if(!i.IncludesShadersStoreWGSL[c])i.IncludesShadersStoreWGSL[c]=z;var U={name:c,shader:z};var m="openpbrCoatLayerData",w=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;if(!i.IncludesShadersStoreWGSL[m])i.IncludesShadersStoreWGSL[m]=w;var X={name:m,shader:w};var _="openpbrThinFilmLayerData",H=`#ifdef THIN_FILM
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[v])i.IncludesShadersStoreWGSL[v]=J;var ee={name:v,shader:J};var S="openpbrDirectLighting",re=`#ifdef LIGHT{X}
...
#endif
`;if(!i.IncludesShadersStoreWGSL[S])i.IncludesShadersStoreWGSL[S]=re;var ae={name:S,shader:re};var E="openpbrBlockPrePass",ie=`#if SCENE_MRT_COUNT>0
...
`;if(!i.ShadersStoreWGSL[h])i.ShadersStoreWGSL[h]=ne;var fe=[ul,hl,xt,Di,ih,vs,ch,$t,Ca,ko,R,Lr,xe,W,tt,fl,te,Bo,Cn,uh,Fr,qt,Gs,ta,hh,fh,xr,En,hn,dh,ph,Vo,N,L,ws,Ku,F,O,Zu,Ju,G,ve,mh,x,y,U,th,eh,X,B,k,Z,Ti,q,Q,ee,ae,We,Ye,_h,oe,dl,gh];for(let e of fe)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var AT={name:h,shader:ne};
export{AT};

//# debugId=1F518315C54CF2CC64756E2164756E21
//# sourceMappingURL=site-r8zher8g.js.map
