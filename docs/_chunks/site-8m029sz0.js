import{ml,_l,gl,xl,Nn,Ln,vl,bl,Sl,Qt}from"./site-0vq9rpwn.js";import{St}from"./site-qq23efnd.js";import{ji}from"./site-xdbjmd04.js";import{lh}from"./site-h4kkq4nd.js";import{bs}from"./site-22qg3tyt.js";import{ie}from"./site-7h7pyq2a.js";import{vr}from"./site-fmg1wtxm.js";import{we,Ne,ye,be,Oe,Le}from"./site-by9w4t7r.js";import{Vs}from"./site-sw7jp60n.js";import{Re,Te}from"./site-1j8bwc31.js";import{st,ht}from"./site-yr13dn0w.js";import{Vi,Gi,zi,Ui}from"./site-fw4kkhv7.js";import{H}from"./site-rze70emw.js";import{li}from"./site-ww6cv9nj.js";import{et}from"./site-d4gw7jdm.js";import{i}from"./site-1yf4ncc8.js";var n="sceneVertexDeclaration",E=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=E;var Rs={name:n,shader:E};var o="openpbrVertexDeclaration",_=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=_;var s={name:o,shader:_};var r="openpbrNormalMapVertexDeclaration",N=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=N;var l={name:r,shader:N};var t="openpbrNormalMapVertex",m=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=m;var f={name:t,shader:m};var a="openpbrVertexShader",A=`#define OPENPBR_VERTEX_SHADER
...
`;if(!i.ShadersStore[a])i.ShadersStore[a]=A;var I=[Rs,ml,s,St,ji,lh,_l,bs,ie,vr,we,Ne,ye,gl,xl,Vs,l,Re,st,Nn,Ln,Vi,Gi,H,zi,Ui,be,Oe,Le,vl,bl,Sl,f,Te,ht,Qt,li,et];for(let e of I)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var RT={name:a,shader:A};
export{Rs,RT};

//# debugId=41DA317AFE225F9B64756E2164756E21
//# sourceMappingURL=site-8m029sz0.js.map
