import{Ct}from"./site-czf9pgne.js";import{Ui}from"./site-egwk4kn6.js";import{nf}from"./site-928p0qq6.js";import{$l,jl,Ql,ei,Ja,ql,Zl,Kl,Jl,ti}from"./site-jev74p6a.js";import{zs}from"./site-xq5t51ez.js";import{re}from"./site-k4eckz4x.js";import{Nr}from"./site-cbsxjzzp.js";import{Qe,qe,Ue,Ne,Xe,$e}from"./site-e0ybn2qx.js";import{dn}from"./site-2xgs12a3.js";import{be,Se}from"./site-v5nrt80s.js";import{lt,ft}from"./site-1fnr94jv.js";import{fr,dr,br,Sr}from"./site-ze3cj5gn.js";import{X}from"./site-vka3s0eg.js";import{mi}from"./site-5zrygvy0.js";import{st}from"./site-gbqy22ka.js";import{i}from"./site-1yf4ncc8.js";var r="openpbrNormalMapVertexDeclaration",o=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=o;var a={name:r,shader:o};var t="openpbrNormalMapVertex",E=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=E;var _={name:t,shader:E};var n="openpbrVertexShader",N=`#define OPENPBR_VERTEX_SHADER
...
}`;if(!i.ShadersStoreWGSL[n])i.ShadersStoreWGSL[n]=N;var s=[Ct,Ui,nf,$l,zs,re,Nr,Qe,qe,Ue,jl,Ql,dn,a,be,lt,ei,fr,dr,X,Ja,ql,br,Sr,Ne,Xe,$e,Zl,Kl,Jl,_,Se,ft,ti,mi,st];for(let e of s)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var QT={name:n,shader:N};
export{QT};

//# debugId=2BA079EA62F9B62264756E2164756E21
//# sourceMappingURL=site-h4amjm3g.js.map
