import{ei as N}from"./site-fs157w4g.js";import{iz as F}from"./site-49z6nh39.js";import{kz as O}from"./site-1zaw3xsb.js";import{lz as C}from"./site-y2r4e2kj.js";import{sz as R}from"./site-tk5je7pd.js";import{tz as S}from"./site-99g3bkr2.js";import{uz as g}from"./site-6jttm5w8.js";import{vz as p}from"./site-z6q3x0pt.js";import{Az as h}from"./site-ztd16syp.js";import{Bz as D}from"./site-6qme1jh9.js";import{Cz as I}from"./site-qmt4t2np.js";import{Fz as v}from"./site-4grmvsrj.js";import{Hz as u}from"./site-t3aad17c.js";import{Tz as L}from"./site-wmwpetg4.js";import{Uz as E}from"./site-zqq9zg2d.js";import{yA as m}from"./site-drqg20zy.js";import{zA as d}from"./site-ejkzt0hp.js";import{AA as s}from"./site-mtwqybh7.js";import{BA as a}from"./site-ja5kdh4m.js";import{DD as e}from"./site-53d1aqt6.js";var i="backgroundFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
#endif
`;if(!e.IncludesShadersStore[i])e.IncludesShadersStore[i]=f;var t={name:i,shader:f};var r="intersectionFunctions",l=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;if(!e.IncludesShadersStore[r])e.IncludesShadersStore[r]=l;var c={name:r,shader:l};var n="backgroundPixelShader",P=`#ifdef TEXTURELODSUPPORT
...
`;if(!e.ShadersStore[n])e.ShadersStore[n]=P;var A=[t,u,N,v,h,I,g,p,R,C,F,S,D,E,a,d,c,s,O,L,m];for(let o of A)if(!e.IncludesShadersStore[o.name])e.IncludesShadersStore[o.name]=o.shader;var re={name:n,shader:P};
export{c as ci,re as di};

//# debugId=E81A6ED2F4368FB564756E2164756E21
//# sourceMappingURL=site-z9am5vkf.js.map
