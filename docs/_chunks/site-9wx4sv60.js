import{DD as e}from"./site-53d1aqt6.js";var i="openpbrDielectricReflectance",t=`struct ReflectanceParams
...
`;if(!e.IncludesShadersStore[i])e.IncludesShadersStore[i]=t;var m={name:i,shader:t};var n="openpbrGeometryInfo",c=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;if(!e.IncludesShadersStore[n])e.IncludesShadersStore[n]=c;var u={name:n,shader:c};var r="openpbrIblFunctions",f=`#ifdef REFLECTION
...
#endif
`;if(!e.IncludesShadersStore[r])e.IncludesShadersStore[r]=f;var S={name:r,shader:f};var o="openpbrSubsurfaceLayerData",s=`float subsurface_weight=vSubsurfaceWeight;vec3 subsurface_color=vSubsurfaceColor.rgb;float subsurface_radius=vSubsurfaceRadius;vec3 subsurface_radius_scale=vSubsurfaceRadiusScale;float subsurface_scatter_anisotropy=clamp(vSubsurfaceScatterAnisotropy,-0.9999,0.9999);
...
#endif
`;if(!e.IncludesShadersStore[a])e.IncludesShadersStore[a]=l;var O={name:a,shader:l};
export{m as zj,u as Aj,S as Bj,N as Cj,O as Dj};

//# debugId=F4E2AD30E80A606064756E2164756E21
//# sourceMappingURL=site-9wx4sv60.js.map
