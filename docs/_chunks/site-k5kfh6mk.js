import{ki as Z}from"./site-4s8y8k0r.js";import{Pz as N}from"./site-cpqzy51y.js";import{Rz as X}from"./site-hndgxdg8.js";import{_z as I}from"./site-4yv0qmr9.js";import{$z as J}from"./site-4gewpr5c.js";import{aA as O}from"./site-mfy2m7vn.js";import{bA as K}from"./site-qr2bwqkn.js";import{dA as Q}from"./site-g3p15j1t.js";import{eA as T}from"./site-k3tc6dn5.js";import{fA as V}from"./site-f96ys6rt.js";import{gA as Y}from"./site-1w2bjfmq.js";import{jA as C}from"./site-0asqx2x4.js";import{kA as H}from"./site-jzegcmyz.js";import{mA as B}from"./site-mvqptzb8.js";import{EA as y}from"./site-wy8z6msz.js";import{FA as A}from"./site-h2yr8kje.js";import{GA as z}from"./site-g0mfbjb2.js";import{HA as x}from"./site-gh3wrscr.js";import{_B as b}from"./site-1q3afg48.js";var k="intersectionFunctions",v=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;if(!b.IncludesShadersStoreWGSL[k])b.IncludesShadersStoreWGSL[k]=v;var w={name:k,shader:v};var q="backgroundPixelShader",_=`#include<backgroundUboDeclaration>
...
`;if(!b.ShadersStoreWGSL[q])b.ShadersStoreWGSL[q]=_;var $=[B,Z,C,Q,T,I,J,K,N,O,V,H,x,y,w,z,X,Y,A];for(let f of $)if(!b.IncludesShadersStoreWGSL[f.name])b.IncludesShadersStoreWGSL[f.name]=f.shader;var s={name:q,shader:_};
export{w as ii,s as ji};

//# debugId=3FC3A0FC60A9C0CC64756E2164756E21
//# sourceMappingURL=site-k5kfh6mk.js.map
