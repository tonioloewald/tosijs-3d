import{ye,Te}from"./site-h1rvyaww.js";import{X}from"./site-vka3s0eg.js";import{at,Ze}from"./site-z38ag2pz.js";import{re}from"./site-k4eckz4x.js";import{je}from"./site-ybj3mbc4.js";import{Vi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var n="skyPixelShader",o=`varying vPositionW: vec3f;
#ifdef VERTEXCOLOR
...
`;if(!i.ShadersStoreWGSL[n])i.ShadersStoreWGSL[n]=o;var a=[ye,X,at,re,Te,je,Ze,Vi];for(let e of a)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var p={name:n,shader:o};export{p as skyPixelShaderWGSL};

//# debugId=7E693165A241B5A264756E2164756E21
//# sourceMappingURL=sky.fragment-adtz8gyf.js.map
