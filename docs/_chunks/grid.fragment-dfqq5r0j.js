import{Ae,Se}from"./site-8vh88wsk.js";import{H}from"./site-rze70emw.js";import{Ze,it}from"./site-zyk6zjdn.js";import{Ke}from"./site-mcwrng38.js";import{_i}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var e="gridPixelShader",n=`#extension GL_OES_standard_derivatives : enable
...
`;if(!i.ShadersStore[e])i.ShadersStore[e]=n;var r=[Ae,H,Ze,Se,it,Ke,_i];for(let o of r)if(!i.IncludesShadersStore[o.name])i.IncludesShadersStore[o.name]=o.shader;var g={name:e,shader:n};export{g as gridPixelShader};

//# debugId=CAA320C38A398C6364756E2164756E21
//# sourceMappingURL=grid.fragment-dfqq5r0j.js.map
