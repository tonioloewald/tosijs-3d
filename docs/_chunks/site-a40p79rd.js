import{Qi as Be,Ri as Ve,Si as ke,Ti as Ye,Ui as Ze}from"./site-wpy5qt7j.js";import{Vi as je}from"./site-aswa33vf.js";import{ij as De,jj as Pe,kj as xe,lj as Me,mj as ye,nj as ze,oj as we,pj as Xe,qj as He}from"./site-6as6w5kv.js";import{rj as Ce}from"./site-xem777mm.js";import{sj as Ge,tj as We}from"./site-2cgvq9cc.js";import{uj as Oe,vj as Ue}from"./site-rgfefsfb.js";import{xj as Fe}from"./site-h3wt8br2.js";import{tk as Ae}from"./site-y0eah2a0.js";import{Vz as de,Wz as ue,Xz as be,Yz as Le}from"./site-m7qhahg1.js";import{Zz as Ne}from"./site-q3edtzfj.js";import{_z as pe}from"./site-3njbfktn.js";import{$z as ge}from"./site-s8vfkdrs.js";import{aA as Se}from"./site-10kj1b29.js";import{bA as ve}from"./site-b510f2ch.js";import{cA as Ee}from"./site-aed59dty.js";import{dA as he}from"./site-asbfwt8t.js";import{eA as Ie}from"./site-55fjnmm4.js";import{fA as Re}from"./site-s8a42t29.js";import{gA as Te}from"./site-p3qvxbqn.js";import{iA as me}from"./site-8jnbj6t8.js";import{jA as ce}from"./site-t4ayqvvy.js";import{kA as _e}from"./site-ngcgfsjk.js";import{lA as le}from"./site-8w53hv8c.js";import{mA as se}from"./site-1nn7frmg.js";import{EA as oe}from"./site-j1mr7gyn.js";import{FA as fe}from"./site-kcvb8kks.js";import{GA as ne}from"./site-4ghhz517.js";import{HA as ie}from"./site-42gdhacc.js";import{_B as e}from"./site-ea0e8ybd.js";var t="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=I;var R={name:t,shader:I};var a="openpbrNormalMapFragmentMainFunctions",b=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[a])e.IncludesShadersStoreWGSL[a]=b;var N={name:a,shader:b};var i="openpbrNormalMapFragmentFunctions",T=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[i])e.IncludesShadersStoreWGSL[i]=T;var L={name:i,shader:T};var o="openpbrConductorReflectance",A=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;if(!e.IncludesShadersStoreWGSL[o])e.IncludesShadersStoreWGSL[o]=A;var F={name:o,shader:A};var n="openpbrAmbientOcclusionFunctions",D=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;if(!e.IncludesShadersStoreWGSL[n])e.IncludesShadersStoreWGSL[n]=D;var O={name:n,shader:D};var f="openpbrVolumeFunctions",C=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=C;var G={name:f,shader:C};var s="openpbrNormalMapFragment",P=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!e.IncludesShadersStoreWGSL[s])e.IncludesShadersStoreWGSL[s]=P;var x={name:s,shader:P};var l="openpbrBlockNormalFinal",M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[l])e.IncludesShadersStoreWGSL[l]=M;var W={name:l,shader:M};var c="openpbrBaseLayerData",y=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;if(!e.IncludesShadersStoreWGSL[c])e.IncludesShadersStoreWGSL[c]=y;var z={name:c,shader:y};var m="openpbrCoatLayerData",U=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;if(!e.IncludesShadersStoreWGSL[m])e.IncludesShadersStoreWGSL[m]=U;var w={name:m,shader:U};var _="openpbrThinFilmLayerData",X=`#ifdef THIN_FILM
...
#endif
`;if(!e.IncludesShadersStoreWGSL[_])e.IncludesShadersStoreWGSL[_]=X;var H={name:_,shader:X};var d="openpbrFuzzLayerData",B=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[d])e.IncludesShadersStoreWGSL[d]=B;var V={name:d,shader:B};var u="openpbrAmbientOcclusionData",k=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;if(!e.IncludesShadersStoreWGSL[u])e.IncludesShadersStoreWGSL[u]=k;var Y={name:u,shader:k};var p="openpbrBackgroundTransmission",Z=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;if(!e.IncludesShadersStoreWGSL[p])e.IncludesShadersStoreWGSL[p]=Z;var j={name:p,shader:Z};var g="openpbrEnvironmentLighting",q=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[g])e.IncludesShadersStoreWGSL[g]=q;var K={name:g,shader:q};var v="openpbrDirectLightingInit",Q=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[v])e.IncludesShadersStoreWGSL[v]=Q;var J={name:v,shader:Q};var S="openpbrDirectLighting",ee=`#ifdef LIGHT{X}
...
#endif
`;if(!e.IncludesShadersStoreWGSL[S])e.IncludesShadersStoreWGSL[S]=ee;var re={name:S,shader:ee};var E="openpbrBlockPrePass",te=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[E])e.IncludesShadersStoreWGSL[E]=te;var ae={name:E,shader:te};var h="openpbrPixelShader",qe=`#define OPENPBR_FRAGMENT_SHADER
...
`;if(!e.ShadersStoreWGSL[h])e.ShadersStoreWGSL[h]=qe;var Ke=[de,ue,se,le,je,me,De,pe,Ee,Oe,R,Ie,ie,_e,oe,be,ce,Ce,Ge,Pe,Re,Se,Fe,ge,xe,Me,Ae,We,ve,ye,ze,Ue,N,L,he,Be,F,O,Ve,ke,G,ne,we,x,W,z,Ze,Ye,w,H,V,Y,Ne,j,K,J,re,Te,fe,Xe,ae,Le,He];for(let r of Ke)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var Yt={name:h,shader:qe};
export{Yt as Pi};

//# debugId=710F48B1E23E492364756E2164756E21
//# sourceMappingURL=site-a40p79rd.js.map
