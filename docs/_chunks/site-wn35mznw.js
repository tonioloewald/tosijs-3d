...
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=a;var Ku={name:e,shader:a};var r="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=t;var Zu={name:r,shader:t};var n="openpbrIblFunctions",c=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=l;var th={name:f,shader:l};
export{Ku,Zu,Ju,eh,th};

//# debugId=E87AA7CD5BFAC36064756E2164756E21
//# sourceMappingURL=site-wn35mznw.js.map
