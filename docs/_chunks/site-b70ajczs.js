import{Wy as k}from"./site-2ywb8x5w.js";import{_B as b}from"./site-1q3afg48.js";var g="iblCdfyPixelShader",q=`precision highp sampler2D;precision highp samplerCube;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;if(!b.ShadersStore[g])b.ShadersStore[g]=q;var v=[k];for(let f of v)if(!b.IncludesShadersStore[f.name])b.IncludesShadersStore[f.name]=f.shader;var y={name:g,shader:q};
export{y as ri};

//# debugId=112DEC5A6DFFD25F64756E2164756E21
//# sourceMappingURL=site-b70ajczs.js.map
