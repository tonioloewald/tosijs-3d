import{Co,Yl,Eo}from"./site-9hv2gc9y.js";import{Rt}from"./site-sdr5y55w.js";import{nr}from"./site-j5z8knjd.js";import{we,Re}from"./site-szcpdvyx.js";import{ct,_t}from"./site-pq1eaaxg.js";import{Y}from"./site-kthp3mjc.js";import{se}from"./site-82m1a6bm.js";import{nt}from"./site-txac35kq.js";import{i}from"./site-1yf4ncc8.js";var o="gaussianSplattingVertexShader",r=`#include<__decl__gaussianSplattingVertex>
...
`;if(!i.ShadersStore[o])i.ShadersStore[o]=r;var t=[Co,Rt,nr,Yl,we,ct,Y,se,Eo,Re,_t,nt];for(let e of t)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var D={name:o,shader:r};export{D as gaussianSplattingVertexShader};

//# debugId=93DF6BE66316454B64756E2164756E21
//# sourceMappingURL=gaussianSplatting.vertex-d7hyc6ah.js.map
