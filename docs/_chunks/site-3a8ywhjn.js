...
#endif
`;if(!i.IncludesShadersStore[_])i.IncludesShadersStore[_]=w;var W={name:_,shader:w};var d="openpbrCoatLayerData",B=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;if(!i.IncludesShadersStore[d])i.IncludesShadersStore[d]=B;var V={name:d,shader:B};var m="openpbrThinFilmLayerData",k=`#ifdef THIN_FILM
...
#endif
`;if(!i.IncludesShadersStore[m])i.IncludesShadersStore[m]=k;var Y={name:m,shader:k};var u="openpbrFuzzLayerData",Z=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
`;if(!i.IncludesShadersStore[E])i.IncludesShadersStore[E]=ee;var oe={name:E,shader:ee};var v="openpbrDirectLightingInit",re=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!i.IncludesShadersStore[v])i.IncludesShadersStore[v]=re;var te={name:v,shader:re};var h="openpbrDirectLighting",ne=`#ifdef LIGHT{X}
...
#endif
`;if(!i.IncludesShadersStore[h])i.IncludesShadersStore[h]=ne;var ae={name:h,shader:ne};var R="openpbrBlockPrePass",se=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!i.IncludesShadersStore[R])i.IncludesShadersStore[R]=se;var ce={name:R,shader:se};var I="openpbrPixelShader",fe=`#define OPENPBR_FRAGMENT_SHADER
...
`;if(!i.ShadersStore[I])i.ShadersStore[I]=fe;var le=[Ko,Zo,Tn,Qo,T,St,ji,lh,bs,vh,Ce,Ee,va,zo,b,Wr,Ae,H,Ze,Jo,ie,Go,An,bh,Hr,Xt,Vs,ea,Sh,yh,vr,Rn,Th,Uo,F,D,Ms,rh,C,M,sh,nh,G,Se,Ch,z,X,W,oh,ah,V,Y,j,K,yi,J,oe,te,ae,Ke,it,Eh,ce,el,Ah];for(let e of le)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var IT={name:I,shader:fe};
export{IT};

//# debugId=4BDE69C8BFB136C164756E2164756E21
//# sourceMappingURL=site-3a8ywhjn.js.map
