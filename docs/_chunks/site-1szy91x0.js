import{_B as b}from"./site-1q3afg48.js";var f="prePassDeclaration",w=`#ifdef PREPASS
...
#endif
#endif
`;if(!b.IncludesShadersStoreWGSL[f])b.IncludesShadersStoreWGSL[f]=w;var C={name:f,shader:w};var k="oitDeclaration",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;if(!b.IncludesShadersStoreWGSL[k])b.IncludesShadersStoreWGSL[k]=y;var I={name:k,shader:y};var q="textureRepetitionFunctions",z=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!b.IncludesShadersStoreWGSL[q])b.IncludesShadersStoreWGSL[q]=z;var N={name:q,shader:z};var v="oitFragment",A=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!b.IncludesShadersStoreWGSL[v])b.IncludesShadersStoreWGSL[v]=A;var T={name:v,shader:A};
export{C as Vz,I as Wz,N as Xz,T as Yz};

//# debugId=3CB9DA883232B7F564756E2164756E21
//# sourceMappingURL=site-1szy91x0.js.map
