import{Hi as k}from"./site-rf08nhfw.js";import{wj as Z}from"./site-f6snzqxn.js";import{gk as z}from"./site-kr23qrtj.js";import{rk as B}from"./site-1xqg9nmh.js";import{Ry as T,Sy as V,Ty as x,Uy as F,Vy as W,Wy as b,Xy as H}from"./site-2897cyvh.js";import{Yy as X}from"./site-2dsa0ab6.js";import{Zy as G}from"./site-3nmpkp6b.js";import{_y as h}from"./site-9mtdy4m3.js";import{bz as P}from"./site-x5qmcm6t.js";import{cz as U}from"./site-awdbhfyx.js";import{dz as Y}from"./site-yb6m4nmt.js";import{ez as g}from"./site-3bypgmhg.js";import{fz as y}from"./site-bmmnqtf5.js";import{Ez as C}from"./site-54ev1dn0.js";import{Fz as v}from"./site-4grmvsrj.js";import{Gz as D}from"./site-ht78zrhn.js";import{Hz as O}from"./site-t3aad17c.js";import{Uz as L}from"./site-zqq9zg2d.js";import{mA as S}from"./site-5hpywt0t.js";import{nA as c}from"./site-e1dgx5rz.js";import{oA as d}from"./site-0wedehmd.js";import{pA as f,qA as u}from"./site-ep0mpq5r.js";import{rA as m}from"./site-pvgny3b5.js";import{sA as M}from"./site-j4rsshqj.js";import{tA as p}from"./site-798xczjz.js";import{uA as I}from"./site-6w2nxcx7.js";import{vA as R}from"./site-ygkkxrec.js";import{wA as A}from"./site-a6n42cp9.js";import{DD as e}from"./site-53d1aqt6.js";var n="openpbrVertexDeclaration",a=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;if(!e.IncludesShadersStore[n])e.IncludesShadersStore[n]=a;var E={name:n,shader:a};var o="openpbrNormalMapVertexDeclaration",_=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;if(!e.IncludesShadersStore[o])e.IncludesShadersStore[o]=_;var N={name:o,shader:_};var r="openpbrNormalMapVertex",s=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;if(!e.IncludesShadersStore[r])e.IncludesShadersStore[r]=s;var l={name:r,shader:s};var t="openpbrVertexShader",w=`#define OPENPBR_VERTEX_SHADER
...
`;if(!e.ShadersStore[t])e.ShadersStore[t]=w;var K=[z,T,E,O,D,k,V,C,v,B,m,f,c,x,F,Z,N,A,I,h,G,g,U,L,Y,P,d,M,u,W,b,H,l,R,p,X,S,y];for(let i of K)if(!e.IncludesShadersStore[i.name])e.IncludesShadersStore[i.name]=i.shader;var Be={name:t,shader:w};
export{Be as Fi};

//# debugId=23D09A6AF4FC192764756E2164756E21
//# sourceMappingURL=site-29k1pp2q.js.map
