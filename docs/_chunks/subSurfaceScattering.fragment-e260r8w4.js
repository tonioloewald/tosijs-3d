import{re}from"./site-k4eckz4x.js";import{Il}from"./site-xt85vzwg.js";import{i}from"./site-1yf4ncc8.js";var r="fibonacci",a=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=a;var l={name:r,shader:a};var t="diffusionProfile",f=`uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=f;var o={name:t,shader:f};var n="subSurfaceScatteringPixelShader",s=`#include<helperFunctions>
#include<fibonacci>
...
`;if(!i.ShadersStoreWGSL[n])i.ShadersStoreWGSL[n]=s;var c=[re,l,Il,o];for(let e of c)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var g={name:n,shader:s};export{g as subSurfaceScatteringPixelShaderWGSL};

//# debugId=6D77D54A071243BD64756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-e260r8w4.js.map
