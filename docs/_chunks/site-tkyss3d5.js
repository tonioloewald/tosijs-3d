import{Nz as a}from"./site-apq8y78s.js";import{DD as e}from"./site-53d1aqt6.js";var t="iblIcdfPixelShader",c=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;if(!e.ShadersStoreWGSL[t])e.ShadersStoreWGSL[t]=c;var i=[a];for(let r of i)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var n={name:t,shader:c};
export{n as ji};

//# debugId=640C25BF5483B48264756E2164756E21
//# sourceMappingURL=site-tkyss3d5.js.map
