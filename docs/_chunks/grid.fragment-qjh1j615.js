import{ye,Te}from"./site-h1rvyaww.js";import{X}from"./site-vka3s0eg.js";import{at,Ze}from"./site-z38ag2pz.js";import{je}from"./site-ybj3mbc4.js";import{Vi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="gridPixelShader",n=`#define SQRT2 1.41421356
#define PI 3.14159
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=n;var o=[ye,X,at,Te,Ze,je,Vi];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var g={name:r,shader:n};export{g as gridPixelShaderWGSL};

//# debugId=F0AD9606350CD02064756E2164756E21
//# sourceMappingURL=grid.fragment-qjh1j615.js.map
