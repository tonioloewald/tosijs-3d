import{FD as e}from"./site-vrsvvb55.js";var t="importanceSampling",a=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
export{l as lj,r as mj};

//# debugId=A5476FE9E660B47C64756E2164756E21
//# sourceMappingURL=site-95sep9bd.js.map
