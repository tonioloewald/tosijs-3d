import{te}from"./site-ybnjbk1z.js";import{$t,qt,Ti}from"./site-hsewys6t.js";import{W}from"./site-6bak08eg.js";import{Ri}from"./site-t1e923cw.js";import{xe,ve}from"./site-t5na8t3j.js";import{tt,Ye}from"./site-m1s81bf3.js";import{ai}from"./site-ndpmtms5.js";import{We}from"./site-cr62e97z.js";import{Mi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="triplanarPixelShader",a=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=a;var f=[te,$t,W,Ri,qt,xe,tt,ve,Ti,ai,We,Ye,Mi];for(let e of f)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var F={name:r,shader:a};export{F as triplanarPixelShaderWGSL};

//# debugId=7CCF35E6ECD1E16464756E2164756E21
//# sourceMappingURL=triplanar.fragment-mzz8zr4n.js.map
