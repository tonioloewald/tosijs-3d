...
`;if(!k.IncludesShadersStoreWGSL[q])k.IncludesShadersStoreWGSL[q]=A;var N={name:q,shader:A};var v="openpbrGeometryInfo",B=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;if(!k.IncludesShadersStoreWGSL[v])k.IncludesShadersStoreWGSL[v]=B;var Q={name:v,shader:B};var w="openpbrIblFunctions",C=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;if(!k.IncludesShadersStoreWGSL[z])k.IncludesShadersStoreWGSL[z]=J;var G={name:z,shader:J};
export{N as Qi,Q as Ri,X as Si,_ as Ti,G as Ui};

//# debugId=19F76207E677F7EC64756E2164756E21
//# sourceMappingURL=site-fp9s0qz7.js.map
