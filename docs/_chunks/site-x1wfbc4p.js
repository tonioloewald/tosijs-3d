import{we,Ne,ye,be,Oe,Le}from"./site-by9w4t7r.js";import{Vi,Gi,zi,Ui}from"./site-fw4kkhv7.js";import{St}from"./site-qq23efnd.js";import{Re,Te}from"./site-1j8bwc31.js";import{Vs}from"./site-sw7jp60n.js";import{pl}from"./site-t2w5fmzn.js";import{i}from"./site-1yf4ncc8.js";var r="geometryVertexDeclaration",t="uniform mat4 viewProjection;uniform mat4 view;";if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=t;var a={name:r,shader:t};var n="geometryUboDeclaration",d=`#include<sceneUboDeclaration>
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=d;var f={name:n,shader:d};var o="geometryVertexShader",c=`precision highp float;
...
`;if(!i.ShadersStore[o])i.ShadersStore[o]=c;var v=[we,Ne,Vi,Gi,ye,a,St,f,Re,Vs,zi,Ui,be,Oe,Le,Te,pl];for(let e of v)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var TT={name:o,shader:c};
export{TT};

//# debugId=A6313E13423BD88664756E2164756E21
//# sourceMappingURL=site-x1wfbc4p.js.map
