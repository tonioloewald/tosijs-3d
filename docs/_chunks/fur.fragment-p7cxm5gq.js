import{te}from"./site-ybnjbk1z.js";import{$t,qt,Ti}from"./site-hsewys6t.js";import{W}from"./site-6bak08eg.js";import{Ri}from"./site-t1e923cw.js";import{tt,Ye}from"./site-m1s81bf3.js";import{xe,ve}from"./site-t5na8t3j.js";import{ai}from"./site-ndpmtms5.js";import{We}from"./site-cr62e97z.js";import{Mi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="furPixelShader",f=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;uniform furColor: vec4f;uniform furLength: f32;varying vPositionW: vec3f;varying vfur_length: f32;
#ifdef NORMAL
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=f;var o=[te,$t,W,Ri,qt,tt,xe,ve,Ti,ai,We,Ye,Mi];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var L={name:r,shader:f};export{L as furPixelShaderWGSL};

//# debugId=F78C76C626953C5C64756E2164756E21
//# sourceMappingURL=fur.fragment-p7cxm5gq.js.map
