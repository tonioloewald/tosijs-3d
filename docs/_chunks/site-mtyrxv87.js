import{bk as O}from"./site-vy2njc55.js";import{Oy as N}from"./site-254yhd3e.js";import{GA as K}from"./site-g0mfbjb2.js";import{HA as J}from"./site-gh3wrscr.js";import{_B as f}from"./site-1q3afg48.js";var v="bayerDitherFunctions",B=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;if(!f.IncludesShadersStoreWGSL[v])f.IncludesShadersStoreWGSL[v]=B;var C={name:v,shader:B};var z="shadowMapFragmentExtraDeclaration",H=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;if(!f.IncludesShadersStoreWGSL[z])f.IncludesShadersStoreWGSL[z]=H;var I={name:z,shader:H};var A="shadowMapPixelShader",Q=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;if(!f.ShadersStoreWGSL[A])f.ShadersStoreWGSL[A]=Q;var T=[N,C,I,J,K,O];for(let q of T)if(!f.IncludesShadersStoreWGSL[q.name])f.IncludesShadersStoreWGSL[q.name]=q.shader;var R={name:A,shader:Q};
export{R as ak};

//# debugId=CF8450D3BD630EE564756E2164756E21
//# sourceMappingURL=site-mtyrxv87.js.map
