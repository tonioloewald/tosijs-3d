import{Ni as r}from"./site-cga9yt6s.js";import{_B as e}from"./site-ea0e8ybd.js";var n="iblVoxelGridPixelShader",o=`#extension GL_EXT_draw_buffers : require
...
#endif
}`;if(!e.ShadersStore[n])e.ShadersStore[n]=o;var i=[r];for(let a of i)if(!e.IncludesShadersStore[a.name])e.IncludesShadersStore[a.name]=a.shader;var P={name:n,shader:o};
export{P as li};

//# debugId=0A5EB350A5EA511464756E2164756E21
//# sourceMappingURL=site-fsrrp606.js.map
