import{ye,Te}from"./site-h1rvyaww.js";import{eo,to,io}from"./site-6gdpr4z0.js";import{ro,rn}from"./site-kd1tj1ge.js";import{re}from"./site-k4eckz4x.js";import{Pl,Ol}from"./site-xnj3gg1x.js";import{Ct}from"./site-czf9pgne.js";import{Nr}from"./site-cbsxjzzp.js";import{Jh,ef,tf,rf,sf}from"./site-r6fkzck5.js";import{i}from"./site-1yf4ncc8.js";var r="geometryPixelShader",f=`#ifdef BUMP
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=f;var n=[ye,eo,ro,to,re,Pl,Ct,Nr,Jh,Ol,rn,ef,tf,Te,io,rf,sf];for(let e of n)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var YT={name:r,shader:f};
export{YT};

//# debugId=D27A1F2C9DBD96A264756E2164756E21
//# sourceMappingURL=site-jn67y208.js.map
