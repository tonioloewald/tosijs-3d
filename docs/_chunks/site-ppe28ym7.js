import{ul,hl,$t,ta,hn,qt,Lr,Fr,fl,Ti,dl}from"./site-hsewys6t.js";import{xt}from"./site-23zackra.js";import{Di}from"./site-v7w00mev.js";import{xh}from"./site-xne5f456.js";import{vs}from"./site-h8pshetj.js";import{ch,Bo,Cn,uh,hh,fh,En,dh,ph,mh,_h,gh}from"./site-b92dzefk.js";import{Ca,ws}from"./site-vx9qbk6e.js";import{ko,Vo}from"./site-a75ec5xt.js";import{xe,ve}from"./site-t5na8t3j.js";import{W}from"./site-6bak08eg.js";import{tt,Ye}from"./site-m1s81bf3.js";import{te}from"./site-ybnjbk1z.js";import{Gs}from"./site-386yabfx.js";import{xr}from"./site-jqf0yjpr.js";import{Sa,ya,Ta}from"./site-p6fvga56.js";import{Zh,ai}from"./site-ndpmtms5.js";import{We}from"./site-cr62e97z.js";import{i}from"./site-1yf4ncc8.js";var r="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
`;if(!i.IncludesShadersStoreWGSL[c])i.IncludesShadersStoreWGSL[c]=B;var y={name:c,shader:B};var l="pbrBlockReflection",V=`#ifdef REFLECTION
...
#endif
`;if(!i.IncludesShadersStoreWGSL[l])i.IncludesShadersStoreWGSL[l]=V;var x={name:l,shader:V};var d="pbrBlockSheen",H=`#ifdef SHEEN
...
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=H;var k={name:d,shader:H};var s="pbrBlockClearcoat",X=`struct clearcoatOutParams
...
return outParams;}
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=X;var Y={name:s,shader:X};var E="pbrBlockIridescence",w=`struct iridescenceOutParams
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[C])i.IncludesShadersStoreWGSL[C]=ee;var re={name:C,shader:ee};var u="pbrBlockReflectance",ie=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=ie;var ae={name:u,shader:ie};var p="pbrBlockDirectLighting",ne=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!i.IncludesShadersStoreWGSL[p])i.IncludesShadersStoreWGSL[p]=ne;var fe={name:p,shader:ne};var v="pbrBlockFinalLitComponents",oe=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[v])i.IncludesShadersStoreWGSL[v]=oe;var ce={name:v,shader:oe};var I="pbrBlockFinalUnlitComponents",le=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!i.ShadersStoreWGSL[O])i.ShadersStoreWGSL[O]=Re;var Ce=[ul,hl,xt,Di,xh,vs,ch,$t,Ca,L,ko,M,Lr,xe,W,tt,fl,te,Bo,Cn,uh,Fr,qt,Gs,ta,hh,fh,xr,En,hn,dh,ph,Vo,Sa,ya,ws,Zh,F,P,b,G,y,x,k,Y,z,q,ve,mh,Ta,J,Ti,j,re,ae,fe,ai,ce,de,Ee,We,Ye,_h,Se,dl,gh];for(let e of Ce)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var MT={name:O,shader:Re};
export{MT};

//# debugId=1CA23BA5C4F5FE3D64756E2164756E21
//# sourceMappingURL=site-ppe28ym7.js.map
