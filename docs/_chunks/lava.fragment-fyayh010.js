import{te}from"./site-ybnjbk1z.js";import{$t,qt,Ti}from"./site-hsewys6t.js";import{Ri}from"./site-t1e923cw.js";import{xe,ve}from"./site-t5na8t3j.js";import{W}from"./site-6bak08eg.js";import{tt,Ye}from"./site-m1s81bf3.js";import{ai}from"./site-ndpmtms5.js";import{We}from"./site-cr62e97z.js";import{Mi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="lavaPixelShader",o=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;varying vPositionW: vec3f;uniform time: f32;uniform speed: f32;uniform movingSpeed: f32;uniform fogColor: vec3f;var noiseTextureSampler: sampler;var noiseTexture: texture_2d<f32>;uniform fogDensity: f32;varying noise: f32;
#ifdef NORMAL
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=o;var f=[te,$t,Ri,qt,xe,W,tt,ve,Ti,ai,We,Ye,Mi];for(let e of f)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var h={name:r,shader:o};export{h as lavaPixelShaderWGSL};

//# debugId=EEF6F3767E6B0C9164756E2164756E21
//# sourceMappingURL=lava.fragment-fyayh010.js.map
