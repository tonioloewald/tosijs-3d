import{rj as D}from"./site-z0ma7nw3.js";import{jA as C}from"./site-0asqx2x4.js";import{_B as k}from"./site-1q3afg48.js";import"./site-cxzb117e.js";var v="fibonacci",y=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;if(!k.IncludesShadersStoreWGSL[v])k.IncludesShadersStoreWGSL[v]=y;var z={name:v,shader:y};var w="diffusionProfile",A=`uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;if(!k.IncludesShadersStoreWGSL[w])k.IncludesShadersStoreWGSL[w]=A;var B={name:w,shader:A};var x="subSurfaceScatteringPixelShader",H=`#include<helperFunctions>
#include<fibonacci>
...
`;if(!k.ShadersStoreWGSL[x])k.ShadersStoreWGSL[x]=H;var I=[C,z,D,B];for(let q of I)if(!k.IncludesShadersStoreWGSL[q.name])k.IncludesShadersStoreWGSL[q.name]=q.shader;var Z={name:x,shader:H};export{Z as subSurfaceScatteringPixelShaderWGSL};

//# debugId=88DC65F65A92AF9064756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-mejzxk6p.js.map
