import{Ct}from"./site-czf9pgne.js";import{Ui}from"./site-egwk4kn6.js";import{re}from"./site-k4eckz4x.js";import{be,Se}from"./site-v5nrt80s.js";import{lt,ft}from"./site-1fnr94jv.js";import{X}from"./site-vka3s0eg.js";import{To}from"./site-jfsj4mx1.js";import{st}from"./site-gbqy22ka.js";import{i}from"./site-1yf4ncc8.js";var t="gaussianSplattingVertexShader",r=`#include<sceneUboDeclaration>
...
`;if(!i.ShadersStoreWGSL[t])i.ShadersStoreWGSL[t]=r;var o=[Ct,Ui,re,be,lt,X,To,Se,ft,st];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var v={name:t,shader:r};export{v as gaussianSplattingVertexShaderWGSL};

//# debugId=26D9FBD5D01C588164756E2164756E21
//# sourceMappingURL=gaussianSplatting.vertex-prx5tvt4.js.map
