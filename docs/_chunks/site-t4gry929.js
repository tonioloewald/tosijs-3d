import{Wy as a}from"./site-stjjqyz5.js";import{_B as e}from"./site-ea0e8ybd.js";var t="iblShadowVoxelTracingPixelShader",o=`precision highp sampler2D;precision highp sampler3D;
...
#endif
#endif
}`;if(!e.ShadersStore[t])e.ShadersStore[t]=o;var r=[a];for(let i of r)if(!e.IncludesShadersStore[i.name])e.IncludesShadersStore[i.name]=i.shader;var c={name:t,shader:o};
export{c as Gi};

//# debugId=55AFE577F9561B2A64756E2164756E21
//# sourceMappingURL=site-t4gry929.js.map
