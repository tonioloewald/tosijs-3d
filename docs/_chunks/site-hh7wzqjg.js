import{Qo,Ko,Zo,Ce,Ee,ea,Xt,Wr,Hr,Jo,yi,el}from"./site-b1m3rnst.js";import{St}from"./site-qq23efnd.js";import{ji}from"./site-xdbjmd04.js";import{Rh}from"./site-0dzk2br9.js";import{bs}from"./site-22qg3tyt.js";import{vh,Go,An,bh,Sh,yh,Rn,Th,Ch,Eh,Ah}from"./site-d31kmrtb.js";import{va,Ms}from"./site-20tfmyw7.js";import{zo,Uo}from"./site-vynzytvb.js";import{Ae,Se}from"./site-8vh88wsk.js";import{H}from"./site-rze70emw.js";import{Ze,it}from"./site-zyk6zjdn.js";import{ie}from"./site-7h7pyq2a.js";import{Vs}from"./site-sw7jp60n.js";import{vr}from"./site-fmg1wtxm.js";import{_a,ga,xa}from"./site-qttfwy7v.js";import{ma,qh,ni}from"./site-4txygyx5.js";import{Ke}from"./site-mcwrng38.js";import{i}from"./site-1yf4ncc8.js";var n="pbrFragmentDeclaration",D=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=D;var M={name:n,shader:D};var a="samplerFragmentAlternateDeclaration",F=`#ifdef _DEFINENAME_
...
#endif
#endif
`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=F;var h={name:a,shader:F};var r="pbrFragmentSamplersDeclaration",g=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=g;var P={name:r,shader:g};var o="pbrBlockAlbedoOpacity",b=`struct albedoOpacityOutParams
...
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=b;var U={name:o,shader:b};var f="pbrBlockReflectivity",y=`struct reflectivityOutParams
...
`;if(!i.IncludesShadersStore[f])i.IncludesShadersStore[f]=y;var B={name:f,shader:y};var t="pbrBlockAmbientOcclusion",G=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=G;var V={name:t,shader:G};var c="pbrBlockAlphaFresnel",x=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;if(!i.IncludesShadersStore[c])i.IncludesShadersStore[c]=x;var k={name:c,shader:x};var l="pbrBlockAnisotropic",X=`#ifdef ANISOTROPIC
...
#endif
`;if(!i.IncludesShadersStore[l])i.IncludesShadersStore[l]=X;var W={name:l,shader:X};var d="pbrBlockReflection",Y=`#ifdef REFLECTION
...
#endif
`;if(!i.IncludesShadersStore[d])i.IncludesShadersStore[d]=Y;var w={name:d,shader:Y};var s="pbrBlockSheen",K=`#ifdef SHEEN
...
#endif
`;if(!i.IncludesShadersStore[s])i.IncludesShadersStore[s]=K;var z={name:s,shader:K};var E="pbrBlockClearcoat",Z=`struct clearcoatOutParams
...
return outParams;}
#endif
`;if(!i.IncludesShadersStore[E])i.IncludesShadersStore[E]=Z;var q={name:E,shader:Z};var R="pbrBlockIridescence",J=`struct iridescenceOutParams
...
#endif
`;if(!i.IncludesShadersStore[R])i.IncludesShadersStore[R]=J;var j={name:R,shader:J};var m="pbrBlockSubSurface",Q=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;if(!i.IncludesShadersStore[m])i.IncludesShadersStore[m]=Q;var ee={name:m,shader:Q};var C="pbrBlockReflectance0",ne=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;if(!i.IncludesShadersStore[C])i.IncludesShadersStore[C]=ne;var ae={name:C,shader:ne};var S="pbrClusteredLightingFunctions",re=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!i.IncludesShadersStore[S])i.IncludesShadersStore[S]=re;var oe={name:S,shader:re};var u="pbrBlockNormalFinal",fe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!i.IncludesShadersStore[u])i.IncludesShadersStore[u]=fe;var te={name:u,shader:fe};var A="pbrBlockLightmapInit",ce=`#ifdef LIGHTMAP
...
#endif
`;if(!i.IncludesShadersStore[A])i.IncludesShadersStore[A]=ce;var le={name:A,shader:ce};var I="pbrBlockGeometryInfo",de=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;if(!i.IncludesShadersStore[I])i.IncludesShadersStore[I]=de;var se={name:I,shader:de};var v="pbrBlockReflectance",Re=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!i.IncludesShadersStore[v])i.IncludesShadersStore[v]=Re;var me={name:v,shader:Re};var T="pbrBlockDirectLighting",ue=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!i.IncludesShadersStore[T])i.IncludesShadersStore[T]=ue;var Ie={name:T,shader:ue};var N="pbrBlockFinalLitComponents",ve=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!i.IncludesShadersStore[N])i.IncludesShadersStore[N]=ve;var Te={name:N,shader:ve};var p="pbrBlockFinalUnlitComponents",Ne=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!i.IncludesShadersStore[p])i.IncludesShadersStore[p]=Ne;var pe={name:p,shader:Ne};var O="pbrBlockFinalColorComposition",Oe=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!i.IncludesShadersStore[O])i.IncludesShadersStore[O]=Oe;var Le={name:O,shader:Oe};var L="pbrBlockPrePass",_e=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!i.IncludesShadersStore[L])i.IncludesShadersStore[L]=_e;var De={name:L,shader:_e};var _="pbrPixelShader",Me=`#define PBR_FRAGMENT_SHADER
...
`;if(!i.ShadersStore[_])i.ShadersStore[_]=Me;var Fe=[Ko,Zo,Qo,M,St,ji,Rh,bs,vh,Ce,Ee,va,h,zo,P,Wr,Ae,H,Ze,Jo,ie,Go,An,bh,Hr,Xt,Vs,ea,Sh,yh,vr,Rn,Th,Uo,_a,ga,Ms,qh,U,B,V,k,W,w,z,q,j,ee,ma,ae,oe,Se,Ch,xa,te,yi,le,se,me,Ie,ni,Te,pe,Le,Ke,it,Eh,De,el,Ah];for(let e of Fe)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var OT={name:_,shader:Me};
export{OT};

//# debugId=37DE604932AE8C4564756E2164756E21
//# sourceMappingURL=site-hh7wzqjg.js.map
