import{_B as b}from"./site-1q3afg48.js";var k="convolutionPixelShader",q=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform screenSize: vec2f;uniform kernel: array<f32,9>;
...
fragmentOutputs.color= vec4f((colorSum/kernelWeight).rgb,1);}`;if(!b.ShadersStoreWGSL[k])b.ShadersStoreWGSL[k]=q;var x={name:k,shader:q};
export{x as Tk};

//# debugId=FED7C9E84CCEAA5364756E2164756E21
//# sourceMappingURL=site-sf583sfk.js.map
