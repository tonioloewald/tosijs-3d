import{i}from"./site-1yf4ncc8.js";var e="openpbrDielectricReflectance",a=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=a;var Jh={name:e,shader:a};var r="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=t;var ef={name:r,shader:t};var n="openpbrIblFunctions",c=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=l;var sf={name:f,shader:l};
export{Jh,ef,tf,rf,sf};

//# debugId=173DBA813A0799F064756E2164756E21
//# sourceMappingURL=site-r6fkzck5.js.map
