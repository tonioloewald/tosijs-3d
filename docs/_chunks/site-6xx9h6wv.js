import{Ae,Se}from"./site-8vh88wsk.js";import{_a,ga,xa}from"./site-qttfwy7v.js";import{va,Ms}from"./site-20tfmyw7.js";import{ie}from"./site-7h7pyq2a.js";import{zo,Uo}from"./site-vynzytvb.js";import{Tn,rh,sh,nh,ah,oh}from"./site-2zypkk64.js";import{St}from"./site-qq23efnd.js";import{vr}from"./site-fmg1wtxm.js";import{i}from"./site-1yf4ncc8.js";var n="mrtFragmentDeclaration",o=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
layout(location=0) out vec4 glFragData[{X}];
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=o;var md={name:n,shader:o};var r="geometryPixelShader",f=`#extension GL_EXT_draw_buffers : require
...
`;if(!i.ShadersStore[r])i.ShadersStore[r]=f;var a=[Ae,md,_a,va,ga,ie,zo,Tn,St,vr,rh,Uo,Ms,sh,nh,Se,xa,ah,oh];for(let e of a)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var CT={name:r,shader:f};
export{md,CT};

//# debugId=98DD2CEF307272F964756E2164756E21
//# sourceMappingURL=site-6xx9h6wv.js.map
