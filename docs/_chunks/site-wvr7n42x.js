import{cj as ii,dj as oi,ej as fi,fj as ti,gj as li,hj as si,ij as Ei,jj as Ri}from"./site-b260ez8p.js";import{kj as ai}from"./site-abm72q48.js";import{lj as ri,mj as ci}from"./site-95sep9bd.js";import{nj as $e}from"./site-a918nrbz.js";import{yj as ei}from"./site-05ywh731.js";import{Gj as ni,Hj as di}from"./site-nhcp112r.js";import{tk as Qe}from"./site-b29n5y33.js";import{lz as ze}from"./site-8tghhsjg.js";import{mz as qe}from"./site-mqydpzdg.js";import{nz as Ge}from"./site-089spfjt.js";import{oz as ge,pz as Pe,qz as be,rz as We,sz as je}from"./site-z0fa9emn.js";import{tz as Ze}from"./site-cbnxyekq.js";import{uz as Be}from"./site-7k1e6xhd.js";import{vz as Ve}from"./site-3ge4xpng.js";import{wz as Ue}from"./site-95fb8q6z.js";import{xz as ye}from"./site-7tmgtqgj.js";import{yz as Ke}from"./site-prpchd8d.js";import{zz as Ye}from"./site-pmbfsnyy.js";import{Az as we}from"./site-8tn216q3.js";import{Bz as He}from"./site-g41kdx90.js";import{Cz as xe}from"./site-5zrynweg.js";import{Dz as Xe}from"./site-awq1qwme.js";import{Ez as ke}from"./site-s8xzdkke.js";import{Gz as Fe}from"./site-vfxdfmf4.js";import{Hz as Me}from"./site-md667va8.js";import{Iz as De}from"./site-61a59p2s.js";import{Jz as _e}from"./site-k72q68wn.js";import{Vz as Je}from"./site-9e7z0b37.js";import{Wz as he}from"./site-p2z3c7py.js";import{AA as Le}from"./site-gczq6jz1.js";import{BA as pe}from"./site-gk9v6jt8.js";import{CA as Oe}from"./site-akv2qr8m.js";import{DA as Ne}from"./site-yzj5pcwj.js";import{FD as e}from"./site-vrsvvb55.js";var n="pbrFragmentDeclaration",D=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;if(!e.IncludesShadersStore[n])e.IncludesShadersStore[n]=D;var M={name:n,shader:D};var a="samplerFragmentAlternateDeclaration",F=`#ifdef _DEFINENAME_
...
#endif
#endif
`;if(!e.IncludesShadersStore[a])e.IncludesShadersStore[a]=F;var h={name:a,shader:F};var r="pbrFragmentSamplersDeclaration",g=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;if(!e.IncludesShadersStore[r])e.IncludesShadersStore[r]=g;var P={name:r,shader:g};var o="pbrBlockAlbedoOpacity",b=`struct albedoOpacityOutParams
...
`;if(!e.IncludesShadersStore[o])e.IncludesShadersStore[o]=b;var U={name:o,shader:b};var f="pbrBlockReflectivity",y=`struct reflectivityOutParams
...
`;if(!e.IncludesShadersStore[f])e.IncludesShadersStore[f]=y;var B={name:f,shader:y};var t="pbrBlockAmbientOcclusion",G=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;if(!e.IncludesShadersStore[t])e.IncludesShadersStore[t]=G;var V={name:t,shader:G};var c="pbrBlockAlphaFresnel",H=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;if(!e.IncludesShadersStore[c])e.IncludesShadersStore[c]=H;var x={name:c,shader:H};var l="pbrBlockAnisotropic",k=`#ifdef ANISOTROPIC
...
#endif
`;if(!e.IncludesShadersStore[l])e.IncludesShadersStore[l]=k;var X={name:l,shader:k};var d="pbrBlockReflection",W=`#ifdef REFLECTION
...
#endif
`;if(!e.IncludesShadersStore[d])e.IncludesShadersStore[d]=W;var Y={name:d,shader:W};var s="pbrBlockSheen",w=`#ifdef SHEEN
...
#endif
`;if(!e.IncludesShadersStore[s])e.IncludesShadersStore[s]=w;var K={name:s,shader:w};var E="pbrBlockClearcoat",z=`struct clearcoatOutParams
...
return outParams;}
#endif
`;if(!e.IncludesShadersStore[E])e.IncludesShadersStore[E]=z;var Z={name:E,shader:z};var R="pbrBlockIridescence",q=`struct iridescenceOutParams
...
#endif
`;if(!e.IncludesShadersStore[R])e.IncludesShadersStore[R]=q;var J={name:R,shader:q};var m="pbrBlockSubSurface",j=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;if(!e.IncludesShadersStore[m])e.IncludesShadersStore[m]=j;var Q={name:m,shader:j};var C="pbrBlockReflectance0",ee=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;if(!e.IncludesShadersStore[C])e.IncludesShadersStore[C]=ee;var ie={name:C,shader:ee};var S="pbrClusteredLightingFunctions",ne=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!e.IncludesShadersStore[S])e.IncludesShadersStore[S]=ne;var ae={name:S,shader:ne};var u="pbrBlockNormalFinal",re=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!e.IncludesShadersStore[u])e.IncludesShadersStore[u]=re;var oe={name:u,shader:re};var A="pbrBlockLightmapInit",fe=`#ifdef LIGHTMAP
...
#endif
`;if(!e.IncludesShadersStore[A])e.IncludesShadersStore[A]=fe;var te={name:A,shader:fe};var I="pbrBlockGeometryInfo",ce=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;if(!e.IncludesShadersStore[I])e.IncludesShadersStore[I]=ce;var le={name:I,shader:ce};var v="pbrBlockReflectance",de=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!e.IncludesShadersStore[v])e.IncludesShadersStore[v]=de;var se={name:v,shader:de};var T="pbrBlockDirectLighting",Ee=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!e.IncludesShadersStore[T])e.IncludesShadersStore[T]=Ee;var Re={name:T,shader:Ee};var N="pbrBlockFinalLitComponents",me=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!e.IncludesShadersStore[N])e.IncludesShadersStore[N]=me;var Ce={name:N,shader:me};var p="pbrBlockFinalUnlitComponents",Se=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!e.IncludesShadersStore[p])e.IncludesShadersStore[p]=Se;var ue={name:p,shader:Se};var O="pbrBlockFinalColorComposition",Ae=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!e.IncludesShadersStore[O])e.IncludesShadersStore[O]=Ae;var Ie={name:O,shader:Ae};var L="pbrBlockPrePass",ve=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!e.IncludesShadersStore[L])e.IncludesShadersStore[L]=ve;var Te={name:L,shader:ve};var _="pbrPixelShader",mi=`#define PBR_FRAGMENT_SHADER
...
`;if(!e.ShadersStore[_])e.ShadersStore[_]=mi;var Ci=[Pe,be,ge,M,_e,De,$e,Fe,ii,Ue,ye,He,h,ni,P,ke,Ne,he,pe,We,Me,ai,ri,oi,Xe,Ve,ei,Be,fi,ti,Qe,ci,li,di,Ye,we,xe,ze,U,B,V,x,X,Y,K,Z,J,Q,Ge,ie,ae,Oe,si,Ke,oe,Ze,te,le,se,Re,qe,Ce,ue,Ie,Je,Le,Ei,Te,je,Ri];for(let i of Ci)if(!e.IncludesShadersStore[i.name])e.IncludesShadersStore[i.name]=i.shader;var ya={name:_,shader:mi};
export{ya as bj};

//# debugId=69878233807ED51A64756E2164756E21
//# sourceMappingURL=site-wvr7n42x.js.map
