import{DD as e}from"./site-53d1aqt6.js";var t="fluidRenderingBilateralBlurPixelShader",r=`uniform sampler2D textureSampler;uniform int maxFilterSize;uniform vec2 blurDir;uniform float projectedParticleConstant;uniform float depthThreshold;varying vec2 vUV;void main(void) {float depth=textureLod(textureSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(vec3(depth),1.);return;}
...
//# debugId=F738E969A621147264756E2164756E21
//# sourceMappingURL=site-2h92ke85.js.map
