import{Me,Ee}from"./site-qtq2tkrz.js";import{Qa,qa,Za}from"./site-3jdegyzx.js";import{Ka,tn}from"./site-g6x77x7h.js";import{se}from"./site-82m1a6bm.js";import{wl,Dl}from"./site-cqwkman4.js";import{ta,af,of,lf,cf,uf}from"./site-bhecy4nw.js";import{Rt}from"./site-sdr5y55w.js";import{Fr}from"./site-817ykrck.js";import{i}from"./site-1yf4ncc8.js";var n="mrtFragmentDeclaration",o=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
layout(location=0) out vec4 glFragData[{X}];
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=o;var Pp={name:n,shader:o};var r="geometryPixelShader",f=`#extension GL_EXT_draw_buffers : require
...
`;if(!i.ShadersStore[r])i.ShadersStore[r]=f;var a=[Me,Pp,Qa,Ka,qa,se,wl,ta,Rt,Fr,af,Dl,tn,of,lf,Ee,Za,cf,uf];for(let e of a)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var jT={name:r,shader:f};
export{Pp,jT};

//# debugId=E93D9A37FF17C7D664756E2164756E21
//# sourceMappingURL=site-tgavb4ff.js.map
