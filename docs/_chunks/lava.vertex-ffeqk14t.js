...
}`;if(!q.ShadersStore[B])q.ShadersStore[B]=$;var v=[E,G,K,H,W,J,Z,_,L,N,O,Q,R,X,T,Y];for(let z of v)if(!q.IncludesShadersStore[z.name])q.IncludesShadersStore[z.name]=z.shader;var S={name:B,shader:$};export{S as lavaVertexShader};

//# debugId=CF141F29DA6194F964756E2164756E21
//# sourceMappingURL=lava.vertex-ffeqk14t.js.map
