import{Ga,tl,za}from"./site-rx8t2h58.js";import{St}from"./site-qq23efnd.js";import{ji}from"./site-xdbjmd04.js";import{Re,Te}from"./site-1j8bwc31.js";import{st,ht}from"./site-yr13dn0w.js";import{H}from"./site-rze70emw.js";import{ie}from"./site-7h7pyq2a.js";import{et}from"./site-d4gw7jdm.js";import{i}from"./site-1yf4ncc8.js";var o="gaussianSplattingVertexShader",r=`#include<__decl__gaussianSplattingVertex>
...
`;if(!i.ShadersStore[o])i.ShadersStore[o]=r;var t=[Ga,St,ji,tl,Re,st,H,ie,za,Te,ht,et];for(let e of t)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var D={name:o,shader:r};export{D as gaussianSplattingVertexShader};

//# debugId=A55787FD55C0C51F64756E2164756E21
//# sourceMappingURL=gaussianSplatting.vertex-nq6jqfve.js.map
