import{i}from"./site-1yf4ncc8.js";var a="bumpFragmentMainFunctions",t=`#ifndef TEXRD_DEFINED
...
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=t;var Sa={name:a,shader:t};var e="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=f;var ya={name:e,shader:f};var r="bumpFragment",m=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=m;var Ta={name:r,shader:m};
export{Sa,ya,Ta};

//# debugId=AA98A8C8638CBBB664756E2164756E21
//# sourceMappingURL=site-p6fvga56.js.map
