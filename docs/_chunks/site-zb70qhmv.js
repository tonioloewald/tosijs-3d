...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=n;var di={name:e,shader:n};var t="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=f;var ja={name:t,shader:f};var o="decalFragment",d=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=d;var Kf={name:o,shader:d};
export{ja,Kf,di};

//# debugId=8C43D3760A3A9E8164756E2164756E21
//# sourceMappingURL=site-zb70qhmv.js.map
