import{ij as pq,jj as Sq,kj as oq,lj as sq,mj as rq,nj as aq,oj as qw,pj as ww,qj as xw}from"./site-7zm2vj66.js";import{rj as dq}from"./site-z0ma7nw3.js";import{sj as hq,tj as nq}from"./site-jb9yaend.js";import{uj as mq,vj as eq}from"./site-jct097fn.js";import{wj as iq}from"./site-25ejvsq5.js";import{xj as tq}from"./site-e4mpgsvc.js";import{tk as cq}from"./site-1w83fgaf.js";import{Qz as Lq}from"./site-bfmrmtj5.js";import{Rz as jq}from"./site-hndgxdg8.js";import{Sz as bq}from"./site-8xgx08cg.js";import{Tz as uq}from"./site-aq6sz7f3.js";import{Uz as Uq}from"./site-gkp898pj.js";import{Vz as yq,Wz as Dq,Xz as Mq,Yz as gq}from"./site-1szy91x0.js";import{Zz as Rq}from"./site-gvnrjj0h.js";import{_z as Iq}from"./site-4yv0qmr9.js";import{$z as Aq}from"./site-4gewpr5c.js";import{aA as Cq}from"./site-mfy2m7vn.js";import{bA as fq}from"./site-qr2bwqkn.js";import{cA as Fq}from"./site-mtg7dm63.js";import{dA as kq}from"./site-g3p15j1t.js";import{eA as Bq}from"./site-k3tc6dn5.js";import{fA as Eq}from"./site-f96ys6rt.js";import{gA as lq}from"./site-1w2bjfmq.js";import{iA as Oq}from"./site-4j4mb0f9.js";import{jA as Gq}from"./site-0asqx2x4.js";import{kA as Pq}from"./site-jzegcmyz.js";import{lA as Wq}from"./site-2zb4ht88.js";import{mA as Nq}from"./site-mvqptzb8.js";import{EA as _q}from"./site-wy8z6msz.js";import{FA as vq}from"./site-h2yr8kje.js";import{GA as $q}from"./site-g0mfbjb2.js";import{HA as Zq}from"./site-gh3wrscr.js";import{_B as q}from"./site-1q3afg48.js";var x="samplerFragmentAlternateDeclaration",A=`#ifdef _DEFINENAME_
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[x])q.IncludesShadersStoreWGSL[x]=A;var f={name:x,shader:A};var z="pbrFragmentSamplersDeclaration",C=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;if(!q.IncludesShadersStoreWGSL[z])q.IncludesShadersStoreWGSL[z]=C;var F={name:z,shader:C};var H="pbrBlockAlbedoOpacity",k=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;if(!q.IncludesShadersStoreWGSL[H])q.IncludesShadersStoreWGSL[H]=k;var B={name:H,shader:k};var J="pbrBlockReflectivity",E=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;if(!q.IncludesShadersStoreWGSL[J])q.IncludesShadersStoreWGSL[J]=E;var M={name:J,shader:E};var K="pbrBlockAmbientOcclusion",U=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;if(!q.IncludesShadersStoreWGSL[K])q.IncludesShadersStoreWGSL[K]=U;var b={name:K,shader:U};var Q="pbrBlockAlphaFresnel",u=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[Q])q.IncludesShadersStoreWGSL[Q]=u;var L={name:Q,shader:u};var T="pbrBlockAnisotropic",R=`#ifdef ANISOTROPIC
...
#endif
`;if(!q.IncludesShadersStoreWGSL[T])q.IncludesShadersStoreWGSL[T]=R;var j={name:T,shader:R};var V="pbrBlockReflection",l=`#ifdef REFLECTION
...
#endif
`;if(!q.IncludesShadersStoreWGSL[V])q.IncludesShadersStoreWGSL[V]=l;var g={name:V,shader:l};var X="pbrBlockSheen",c=`#ifdef SHEEN
...
#endif
`;if(!q.IncludesShadersStoreWGSL[X])q.IncludesShadersStoreWGSL[X]=c;var i={name:X,shader:c};var Y="pbrBlockClearcoat",t=`struct clearcoatOutParams
...
return outParams;}
#endif
`;if(!q.IncludesShadersStoreWGSL[Y])q.IncludesShadersStoreWGSL[Y]=t;var p={name:Y,shader:t};var Z="pbrBlockIridescence",m=`struct iridescenceOutParams
...
#endif
`;if(!q.IncludesShadersStoreWGSL[Z])q.IncludesShadersStoreWGSL[Z]=m;var d={name:Z,shader:m};var _="pbrBlockSubSurface",h=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;if(!q.IncludesShadersStoreWGSL[_])q.IncludesShadersStoreWGSL[_]=h;var S={name:_,shader:h};var $="pbrBlockNormalFinal",o=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[$])q.IncludesShadersStoreWGSL[$]=o;var s={name:$,shader:o};var v="pbrBlockLightmapInit",n=`#ifdef LIGHTMAP
...
#endif
`;if(!q.IncludesShadersStoreWGSL[v])q.IncludesShadersStoreWGSL[v]=n;var r={name:v,shader:n};var N="pbrBlockGeometryInfo",a=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[N])q.IncludesShadersStoreWGSL[N]=a;var e={name:N,shader:a};var W="pbrBlockReflectance",qq=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[W])q.IncludesShadersStoreWGSL[W]=qq;var wq={name:W,shader:qq};var G="pbrBlockDirectLighting",xq=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!q.IncludesShadersStoreWGSL[G])q.IncludesShadersStoreWGSL[G]=xq;var zq={name:G,shader:xq};var O="pbrBlockFinalLitComponents",Hq=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[O])q.IncludesShadersStoreWGSL[O]=Hq;var Jq={name:O,shader:Hq};var P="pbrBlockFinalUnlitComponents",Kq=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!q.IncludesShadersStoreWGSL[P])q.IncludesShadersStoreWGSL[P]=Kq;var Qq={name:P,shader:Kq};var y="pbrBlockFinalColorComposition",Tq=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!q.IncludesShadersStoreWGSL[y])q.IncludesShadersStoreWGSL[y]=Tq;var Vq={name:y,shader:Tq};var D="pbrBlockPrePass",Xq=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[D])q.IncludesShadersStoreWGSL[D]=Xq;var Yq={name:D,shader:Xq};var I="pbrPixelShader",zw=`#define PBR_FRAGMENT_SHADER
...
`;if(!q.ShadersStoreWGSL[I])q.ShadersStoreWGSL[I]=zw;var Hw=[yq,Dq,Nq,Wq,iq,Oq,pq,Iq,Fq,f,mq,F,Bq,Zq,Pq,_q,Mq,Gq,dq,hq,Sq,Eq,Cq,tq,Aq,oq,sq,cq,nq,fq,rq,aq,eq,Uq,bq,kq,Lq,B,M,b,L,j,g,i,p,d,S,$q,qw,uq,s,Rq,r,e,wq,zq,jq,Jq,Qq,Vq,lq,vq,ww,Yq,gq,xw];for(let w of Hw)if(!q.IncludesShadersStoreWGSL[w.name])q.IncludesShadersStoreWGSL[w.name]=w.shader;var Xz={name:I,shader:zw};
export{Xz as hj};

//# debugId=5E4A712B840A434564756E2164756E21
//# sourceMappingURL=site-40jf0ffz.js.map
