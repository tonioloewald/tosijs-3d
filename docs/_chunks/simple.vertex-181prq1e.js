...
`;if(!j.ShadersStoreWGSL[w])j.ShadersStoreWGSL[w]=Z;var _=[y,z,H,B,U,E,R,T,I,J,K,N,Y,O,X,Q];for(let q of _)if(!j.IncludesShadersStoreWGSL[q.name])j.IncludesShadersStoreWGSL[q.name]=q.shader;var V={name:w,shader:Z};export{V as simpleVertexShaderWGSL};

//# debugId=C839CB14B977FD4664756E2164756E21
//# sourceMappingURL=simple.vertex-181prq1e.js.map
