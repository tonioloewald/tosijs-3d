...
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=t;var eo={name:a,shader:t};var e="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=f;var to={name:e,shader:f};var r="bumpFragment",m=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=m;var io={name:r,shader:m};
export{eo,to,io};

//# debugId=04E98CAF290DD8A664756E2164756E21
//# sourceMappingURL=site-6gdpr4z0.js.map
