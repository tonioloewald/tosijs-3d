...
velocityLinear.b,velocityLinear.a);fragmentOutputs.color=vec4f(velocityLinear.rgb,1.0);} else if (uv.x<=0.75) {fragmentOutputs.color=vec4f(worldPosition.rgb,1.0);} else {fragmentOutputs.color=vec4f(worldNormal.rgb,1.0);}}}`;if(!e.ShadersStoreWGSL[r])e.ShadersStoreWGSL[r]=a;var l={name:r,shader:a};
export{l as Sg};

//# debugId=C19207AFFB73A3B764756E2164756E21
//# sourceMappingURL=site-v1qkp6pb.js.map
