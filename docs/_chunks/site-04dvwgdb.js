import{Wy as o}from"./site-stjjqyz5.js";import{_B as e}from"./site-ea0e8ybd.js";var i="iblIcdfPixelShader",c=`precision highp sampler2D;
...
`;if(!e.ShadersStore[i])e.ShadersStore[i]=c;var r=[o];for(let t of r)if(!e.IncludesShadersStore[t.name])e.IncludesShadersStore[t.name]=t.shader;var n={name:i,shader:c};
export{n as di};

//# debugId=BB592AE908A26AA364756E2164756E21
//# sourceMappingURL=site-04dvwgdb.js.map
