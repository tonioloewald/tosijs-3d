import{_B as k}from"./site-1q3afg48.js";var q="openpbrDielectricReflectance",A=`struct ReflectanceParams
...
`;if(!k.IncludesShadersStore[q])k.IncludesShadersStore[q]=A;var N={name:q,shader:A};var v="openpbrGeometryInfo",B=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;if(!k.IncludesShadersStore[v])k.IncludesShadersStore[v]=B;var Q={name:v,shader:B};var w="openpbrIblFunctions",C=`#ifdef REFLECTION
...
#endif
`;if(!k.IncludesShadersStore[w])k.IncludesShadersStore[w]=C;var X={name:w,shader:C};var x="openpbrSubsurfaceLayerData",H=`float subsurface_weight=vSubsurfaceWeight;vec3 subsurface_color=vSubsurfaceColor.rgb;float subsurface_radius=vSubsurfaceRadius;vec3 subsurface_radius_scale=vSubsurfaceRadiusScale;float subsurface_scatter_anisotropy=clamp(vSubsurfaceScatterAnisotropy,-0.9999,0.9999);
...
#endif
`;if(!k.IncludesShadersStore[z])k.IncludesShadersStore[z]=J;var G={name:z,shader:J};
export{N as Yi,Q as Zi,X as _i,_ as $i,G as aj};

//# debugId=F150C6B7F7F214E864756E2164756E21
//# sourceMappingURL=site-rdjk2amt.js.map
