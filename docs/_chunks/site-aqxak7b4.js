import{_B as e}from"./site-ea0e8ybd.js";var t="gaussianSplatting",s=`fn getDataUV(index: f32,dataTextureSize: vec2f)->vec2<f32> {let y: f32=floor(index/dataTextureSize.x);let x: f32=index-y*dataTextureSize.x;return vec2f((x+0.5),(y+0.5));}
...
#endif
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=s;var l={name:t,shader:s};
export{l as _y};

//# debugId=2917B837CCE5C59164756E2164756E21
//# sourceMappingURL=site-aqxak7b4.js.map
