import{ij as Ye,jj as qe,kj as Ze,lj as Je,mj as je,nj as $e,oj as rr,pj as ir,qj as ar}from"./site-6as6w5kv.js";import{rj as ze}from"./site-xem777mm.js";import{sj as Ke,tj as Qe}from"./site-2cgvq9cc.js";import{uj as we,vj as er}from"./site-rgfefsfb.js";import{wj as ke}from"./site-twe5rh17.js";import{xj as Xe}from"./site-h3wt8br2.js";import{tk as He}from"./site-y0eah2a0.js";import{Qz as Be}from"./site-hycpsns9.js";import{Rz as We}from"./site-gggacazs.js";import{Sz as Ue}from"./site-wsnkc80r.js";import{Tz as Ge}from"./site-1s93pgjw.js";import{Uz as be}from"./site-d3t1wg2m.js";import{Vz as Ne,Wz as Oe,Xz as he,Yz as xe}from"./site-m7qhahg1.js";import{Zz as ye}from"./site-q3edtzfj.js";import{_z as Te}from"./site-3njbfktn.js";import{$z as Le}from"./site-s8vfkdrs.js";import{aA as Me}from"./site-10kj1b29.js";import{bA as _e}from"./site-b510f2ch.js";import{cA as De}from"./site-aed59dty.js";import{dA as Fe}from"./site-asbfwt8t.js";import{eA as ge}from"./site-55fjnmm4.js";import{fA as Pe}from"./site-s8a42t29.js";import{gA as Ve}from"./site-p3qvxbqn.js";import{iA as Ie}from"./site-8jnbj6t8.js";import{jA as ve}from"./site-t4ayqvvy.js";import{kA as Ae}from"./site-ngcgfsjk.js";import{lA as pe}from"./site-8w53hv8c.js";import{mA as ue}from"./site-1nn7frmg.js";import{EA as Se}from"./site-j1mr7gyn.js";import{FA as Ce}from"./site-kcvb8kks.js";import{GA as Re}from"./site-4ghhz517.js";import{HA as me}from"./site-42gdhacc.js";import{_B as e}from"./site-ea0e8ybd.js";var i="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[i])e.IncludesShadersStoreWGSL[i]=T;var L={name:i,shader:T};var a="pbrFragmentSamplersDeclaration",_=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[a])e.IncludesShadersStoreWGSL[a]=_;var M={name:a,shader:_};var n="pbrBlockAlbedoOpacity",D=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;if(!e.IncludesShadersStoreWGSL[n])e.IncludesShadersStoreWGSL[n]=D;var F={name:n,shader:D};var f="pbrBlockReflectivity",g=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=g;var P={name:f,shader:g};var o="pbrBlockAmbientOcclusion",h=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;if(!e.IncludesShadersStoreWGSL[o])e.IncludesShadersStoreWGSL[o]=h;var b={name:o,shader:h};var t="pbrBlockAlphaFresnel",U=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=U;var G={name:t,shader:U};var c="pbrBlockAnisotropic",B=`#ifdef ANISOTROPIC
...
#endif
`;if(!e.IncludesShadersStoreWGSL[c])e.IncludesShadersStoreWGSL[c]=B;var y={name:c,shader:B};var l="pbrBlockReflection",W=`#ifdef REFLECTION
...
#endif
`;if(!e.IncludesShadersStoreWGSL[l])e.IncludesShadersStoreWGSL[l]=W;var V={name:l,shader:W};var d="pbrBlockSheen",x=`#ifdef SHEEN
...
#endif
`;if(!e.IncludesShadersStoreWGSL[d])e.IncludesShadersStoreWGSL[d]=x;var H={name:d,shader:x};var s="pbrBlockClearcoat",k=`struct clearcoatOutParams
...
return outParams;}
#endif
`;if(!e.IncludesShadersStoreWGSL[s])e.IncludesShadersStoreWGSL[s]=k;var X={name:s,shader:k};var E="pbrBlockIridescence",Y=`struct iridescenceOutParams
...
#endif
`;if(!e.IncludesShadersStoreWGSL[E])e.IncludesShadersStoreWGSL[E]=Y;var w={name:E,shader:Y};var m="pbrBlockSubSurface",z=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;if(!e.IncludesShadersStoreWGSL[m])e.IncludesShadersStoreWGSL[m]=z;var K={name:m,shader:z};var S="pbrBlockNormalFinal",q=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[S])e.IncludesShadersStoreWGSL[S]=q;var Z={name:S,shader:q};var R="pbrBlockLightmapInit",J=`#ifdef LIGHTMAP
...
#endif
`;if(!e.IncludesShadersStoreWGSL[R])e.IncludesShadersStoreWGSL[R]=J;var Q={name:R,shader:J};var C="pbrBlockGeometryInfo",j=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[C])e.IncludesShadersStoreWGSL[C]=j;var ee={name:C,shader:j};var u="pbrBlockReflectance",re=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[u])e.IncludesShadersStoreWGSL[u]=re;var ie={name:u,shader:re};var p="pbrBlockDirectLighting",ae=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!e.IncludesShadersStoreWGSL[p])e.IncludesShadersStoreWGSL[p]=ae;var ne={name:p,shader:ae};var v="pbrBlockFinalLitComponents",fe=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[v])e.IncludesShadersStoreWGSL[v]=fe;var oe={name:v,shader:fe};var I="pbrBlockFinalUnlitComponents",te=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!e.IncludesShadersStoreWGSL[I])e.IncludesShadersStoreWGSL[I]=te;var ce={name:I,shader:te};var A="pbrBlockFinalColorComposition",le=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!e.IncludesShadersStoreWGSL[A])e.IncludesShadersStoreWGSL[A]=le;var de={name:A,shader:le};var N="pbrBlockPrePass",se=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[N])e.IncludesShadersStoreWGSL[N]=se;var Ee={name:N,shader:se};var O="pbrPixelShader",nr=`#define PBR_FRAGMENT_SHADER
...
`;if(!e.ShadersStoreWGSL[O])e.ShadersStoreWGSL[O]=nr;var fr=[Ne,Oe,ue,pe,ke,Ie,Ye,Te,De,L,we,M,ge,me,Ae,Se,he,ve,ze,Ke,qe,Pe,Me,Xe,Le,Ze,Je,He,Qe,_e,je,$e,er,be,Ue,Fe,Be,F,P,b,G,y,V,H,X,w,K,Re,rr,Ge,Z,ye,Q,ee,ie,ne,We,oe,ce,de,Ve,Ce,ir,Ee,xe,ar];for(let r of fr)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var sa={name:O,shader:nr};
export{sa as hj};

//# debugId=AA205E0FF9AF1BAD64756E2164756E21
//# sourceMappingURL=site-b16q89xz.js.map
