import{ie}from"./site-7h7pyq2a.js";import{Go}from"./site-d31kmrtb.js";import{i}from"./site-1yf4ncc8.js";var r="fibonacci",a=`#define rcp(x) 1./x
...
totalWeight=max(totalWeight,HALF_MIN);gl_FragColor=vec4(inputColor.rgb+albedo*max(totalIrradiance/totalWeight,vec3(0.0)),1.);}`;if(!i.ShadersStore[o])i.ShadersStore[o]=f;var s=[ie,n,Go,c];for(let e of s)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var g={name:o,shader:f};export{g as subSurfaceScatteringPixelShader};

//# debugId=DBE1F738A693717A64756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-q2d1rw0b.js.map
