...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=a;var Pl={name:e,shader:a};var r="pbrIBLFunctions",n=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=n;var Ol={name:r,shader:n};
export{Pl,Ol};

//# debugId=29A9AAA9754EAB3164756E2164756E21
//# sourceMappingURL=site-xnj3gg1x.js.map
