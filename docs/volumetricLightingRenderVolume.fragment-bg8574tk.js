import{lA as q}from"./site-5xv9r9ax.js";import{mA as p}from"./site-8j04nt09.js";import{_B as f}from"./site-7jxv124x.js";import"./site-68gwymhw.js";var k="volumetricLightingRenderVolumePixelShader",v=`#include<sceneUboDeclaration>
...
`;if(!f.ShadersStoreWGSL[k])f.ShadersStoreWGSL[k]=v;var w=[p,q];for(let g of w)if(!f.IncludesShadersStoreWGSL[g.name])f.IncludesShadersStoreWGSL[g.name]=g.shader;var A={name:k,shader:v};export{A as volumetricLightingRenderVolumePixelShaderWGSL};

//# debugId=4792A543F632579764756E2164756E21
//# sourceMappingURL=volumetricLightingRenderVolume.fragment-bg8574tk.js.map
