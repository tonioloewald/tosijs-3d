import{_B as f}from"./site-7jxv124x.js";var k="fluentVertexShader",p=`precision highp float;attribute vec3 position;attribute vec3 normal;attribute vec2 uv;uniform mat4 world;uniform mat4 viewProjection;varying vec2 vUV;
#ifdef BORDER
...
`;if(!f.ShadersStore[k])f.ShadersStore[k]=p;var u={name:k,shader:p};
export{u as lg};

//# debugId=06DDD66668AF566D64756E2164756E21
//# sourceMappingURL=site-v7wjvgkf.js.map
