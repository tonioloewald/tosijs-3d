import{sk as w}from"./site-0v03sxx2.js";import{tk as v}from"./site-hd92pkjd.js";import{jA as q}from"./site-9xy7s866.js";import{_B as f}from"./site-7jxv124x.js";var k="screenSpaceReflection2PixelShader",x=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;if(!f.ShadersStoreWGSL[k])f.ShadersStoreWGSL[k]=x;var z=[q,v,w];for(let g of z)if(!f.IncludesShadersStoreWGSL[g.name])f.IncludesShadersStoreWGSL[g.name]=g.shader;var J={name:k,shader:x};
export{J as rk};

//# debugId=F5F79602DBA9FF3064756E2164756E21
//# sourceMappingURL=site-9xmpa63k.js.map
