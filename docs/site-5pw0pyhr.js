...
#endif
`;if(!q.IncludesShadersStore[G])q.IncludesShadersStore[G]=V;var B={name:G,shader:V};var H="openpbrNormalMapFragmentMainFunctions",N=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;if(!q.IncludesShadersStore[H])q.IncludesShadersStore[H]=N;var y={name:H,shader:N};var J="openpbrNormalMapFragmentFunctions",D=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;if(!q.IncludesShadersStore[J])q.IncludesShadersStore[J]=D;var F={name:J,shader:D};var K="openpbrConductorReflectance",E=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;if(!q.IncludesShadersStore[K])q.IncludesShadersStore[K]=E;var U={name:K,shader:E};var Q="openpbrAmbientOcclusionFunctions",R=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;if(!q.IncludesShadersStore[Q])q.IncludesShadersStore[Q]=R;var M={name:Q,shader:R};var W="openpbrVolumeFunctions",b=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;if(!q.IncludesShadersStore[W])q.IncludesShadersStore[W]=b;var l={name:W,shader:b};var X="openpbrNormalMapFragment",L=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;if(!q.IncludesShadersStore[X])q.IncludesShadersStore[X]=L;var u={name:X,shader:L};var Y="openpbrBlockNormalFinal",j=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!q.IncludesShadersStore[Y])q.IncludesShadersStore[Y]=j;var c={name:Y,shader:j};var Z="openpbrBaseLayerData",g=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;if(!q.IncludesShadersStore[Z])q.IncludesShadersStore[Z]=g;var i={name:Z,shader:g};var _="openpbrCoatLayerData",S=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;if(!q.IncludesShadersStore[_])q.IncludesShadersStore[_]=S;var m={name:_,shader:S};var $="openpbrThinFilmLayerData",h=`#ifdef THIN_FILM
...
#endif
`;if(!q.IncludesShadersStore[$])q.IncludesShadersStore[$]=h;var p={name:$,shader:h};var v="openpbrFuzzLayerData",d=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;if(!q.IncludesShadersStore[v])q.IncludesShadersStore[v]=d;var t={name:v,shader:d};var I="openpbrAmbientOcclusionData",o=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;if(!q.IncludesShadersStore[I])q.IncludesShadersStore[I]=o;var s={name:I,shader:o};var z="openpbrBackgroundTransmission",n=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;if(!q.IncludesShadersStore[z])q.IncludesShadersStore[z]=n;var r={name:z,shader:n};var A="openpbrEnvironmentLighting",a=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;if(!q.IncludesShadersStore[A])q.IncludesShadersStore[A]=a;var e={name:A,shader:a};var O="openpbrDirectLightingInit",qq=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!q.IncludesShadersStore[O])q.IncludesShadersStore[O]=qq;var wq={name:O,shader:qq};var P="openpbrDirectLighting",xq=`#ifdef LIGHT{X}
...
#endif
`;if(!q.IncludesShadersStore[P])q.IncludesShadersStore[P]=xq;var Gq={name:P,shader:xq};var T="openpbrBlockPrePass",Hq=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!q.IncludesShadersStore[T])q.IncludesShadersStore[T]=Hq;var Jq={name:T,shader:Hq};var f="openpbrPixelShader",aq=`#define OPENPBR_FRAGMENT_SHADER
...
`;if(!q.ShadersStore[f])q.ShadersStore[f]=aq;var eq=[zq,Aq,Uq,Iq,C,Yq,Zq,rq,$q,Mq,Oq,Pq,kq,bq,B,Vq,Kq,vq,Qq,Nq,_q,lq,Lq,uq,Bq,fq,Rq,Tq,jq,cq,Eq,gq,iq,Sq,y,F,Cq,dq,U,M,tq,oq,l,Wq,mq,u,c,i,nq,sq,m,p,t,s,yq,r,e,wq,Gq,Dq,Xq,hq,Jq,Fq,pq];for(let w of eq)if(!q.IncludesShadersStore[w.name])q.IncludesShadersStore[w.name]=w.shader;var wG={name:f,shader:aq};
export{wG as Xi};

//# debugId=6F5C0A4351132F7464756E2164756E21
//# sourceMappingURL=site-5pw0pyhr.js.map
