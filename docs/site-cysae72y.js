import{jA as k}from"./site-9xy7s866.js";import{_B as b}from"./site-7jxv124x.js";var g="iblIcdfPixelShader",q=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;if(!b.ShadersStoreWGSL[g])b.ShadersStoreWGSL[g]=q;var v=[k];for(let f of v)if(!b.IncludesShadersStoreWGSL[f.name])b.IncludesShadersStoreWGSL[f.name]=f.shader;var y={name:g,shader:q};
export{y as bi};

//# debugId=46A1C58A16F6934E64756E2164756E21
//# sourceMappingURL=site-cysae72y.js.map
