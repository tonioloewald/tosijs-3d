import{Aj as qw,Bj as Hw,Cj as Jw,Dj as Kw,Ej as Tw,Fj as Xw,Gj as Yw,Hj as Zw}from"./site-tn5aa0eh.js";import{Ij as xw}from"./site-mw6n3pm9.js";import{Jj as zw,Kj as Qw}from"./site-3qpdk318.js";import{Lj as ww,Mj as Ww}from"./site-tv83t9c9.js";import{Nj as aq}from"./site-ykx1tqfk.js";import{Oj as eq}from"./site-wmp59vfs.js";import{wk as rq}from"./site-myyfmyk6.js";import{ry as hq}from"./site-xq3c4zh5.js";import{sy as oq}from"./site-nnjax1p2.js";import{ty as uq}from"./site-p7tb0fk3.js";import{uy as Sq}from"./site-mq5xtg2a.js";import{vy as mq}from"./site-8v5bdvwy.js";import{wy as tq}from"./site-dvha5a55.js";import{Ay as pq,By as nq,xy as Eq,yy as Mq,zy as Uq}from"./site-x5acyptj.js";import{Cy as dq}from"./site-t0yknckb.js";import{Dy as Lq}from"./site-atd54w7j.js";import{Ey as Rq}from"./site-wnfkq0sz.js";import{Fy as bq}from"./site-aeme12pw.js";import{Gy as jq}from"./site-8eg5gf3m.js";import{Hy as lq}from"./site-60ttwgzr.js";import{Iy as gq}from"./site-62a8vf1e.js";import{Jy as cq}from"./site-xt9984b7.js";import{Ky as iq}from"./site-f571hc4v.js";import{My as kq}from"./site-9p36bdtv.js";import{Ry as sq}from"./site-5mec8xk8.js";import{Wy as Fq}from"./site-58j2ewnw.js";import{Xy as fq}from"./site-eay31fke.js";import{Yy as Dq}from"./site-ggwxysr4.js";import{Zy as Bq}from"./site-vnstybdd.js";import{mz as yq}from"./site-2bfnsn9v.js";import{nz as Cq}from"./site-f9x4gp6z.js";import{oz as Aq}from"./site-fdg03zpz.js";import{pz as Iq}from"./site-ex7cky94.js";import{_B as q}from"./site-7jxv124x.js";var x="pbrFragmentDeclaration",F=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;if(!q.IncludesShadersStore[x])q.IncludesShadersStore[x]=F;var k={name:x,shader:F};var z="samplerFragmentAlternateDeclaration",B=`#ifdef _DEFINENAME_
...
#endif
#endif
`;if(!q.IncludesShadersStore[z])q.IncludesShadersStore[z]=B;var E={name:z,shader:B};var H="pbrFragmentSamplersDeclaration",M=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;if(!q.IncludesShadersStore[H])q.IncludesShadersStore[H]=M;var U={name:H,shader:M};var J="pbrBlockAlbedoOpacity",L=`struct albedoOpacityOutParams
...
`;if(!q.IncludesShadersStore[J])q.IncludesShadersStore[J]=L;var R={name:J,shader:L};var K="pbrBlockReflectivity",b=`struct reflectivityOutParams
...
`;if(!q.IncludesShadersStore[K])q.IncludesShadersStore[K]=b;var u={name:K,shader:b};var Q="pbrBlockAmbientOcclusion",j=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;if(!q.IncludesShadersStore[Q])q.IncludesShadersStore[Q]=j;var l={name:Q,shader:j};var T="pbrBlockAlphaFresnel",g=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;if(!q.IncludesShadersStore[T])q.IncludesShadersStore[T]=g;var c={name:T,shader:g};var W="pbrBlockAnisotropic",i=`#ifdef ANISOTROPIC
...
#endif
`;if(!q.IncludesShadersStore[W])q.IncludesShadersStore[W]=i;var p={name:W,shader:i};var X="pbrBlockReflection",m=`#ifdef REFLECTION
...
#endif
`;if(!q.IncludesShadersStore[X])q.IncludesShadersStore[X]=m;var t={name:X,shader:m};var Y="pbrBlockSheen",S=`#ifdef SHEEN
...
#endif
`;if(!q.IncludesShadersStore[Y])q.IncludesShadersStore[Y]=S;var h={name:Y,shader:S};var Z="pbrBlockClearcoat",d=`struct clearcoatOutParams
...
return outParams;}
#endif
`;if(!q.IncludesShadersStore[Z])q.IncludesShadersStore[Z]=d;var o={name:Z,shader:d};var _="pbrBlockIridescence",s=`struct iridescenceOutParams
...
#endif
`;if(!q.IncludesShadersStore[_])q.IncludesShadersStore[_]=s;var n={name:_,shader:s};var $="pbrBlockSubSurface",r=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;if(!q.IncludesShadersStore[$])q.IncludesShadersStore[$]=r;var a={name:$,shader:r};var v="pbrBlockReflectance0",e=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;if(!q.IncludesShadersStore[v])q.IncludesShadersStore[v]=e;var qq={name:v,shader:e};var G="pbrClusteredLightingFunctions",wq=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!q.IncludesShadersStore[G])q.IncludesShadersStore[G]=wq;var xq={name:G,shader:wq};var N="pbrBlockNormalFinal",zq=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!q.IncludesShadersStore[N])q.IncludesShadersStore[N]=zq;var Hq={name:N,shader:zq};var O="pbrBlockLightmapInit",Jq=`#ifdef LIGHTMAP
...
#endif
`;if(!q.IncludesShadersStore[O])q.IncludesShadersStore[O]=Jq;var Kq={name:O,shader:Jq};var P="pbrBlockGeometryInfo",Qq=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;if(!q.IncludesShadersStore[P])q.IncludesShadersStore[P]=Qq;var Tq={name:P,shader:Qq};var V="pbrBlockReflectance",Wq=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!q.IncludesShadersStore[V])q.IncludesShadersStore[V]=Wq;var Xq={name:V,shader:Wq};var I="pbrBlockDirectLighting",Yq=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!q.IncludesShadersStore[I])q.IncludesShadersStore[I]=Yq;var Zq={name:I,shader:Yq};var y="pbrBlockFinalLitComponents",_q=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!q.IncludesShadersStore[y])q.IncludesShadersStore[y]=_q;var $q={name:y,shader:_q};var A="pbrBlockFinalUnlitComponents",vq=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!q.IncludesShadersStore[A])q.IncludesShadersStore[A]=vq;var Gq={name:A,shader:vq};var C="pbrBlockFinalColorComposition",Nq=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!q.IncludesShadersStore[C])q.IncludesShadersStore[C]=Nq;var Oq={name:C,shader:Nq};var D="pbrBlockPrePass",Pq=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;if(!q.IncludesShadersStore[D])q.IncludesShadersStore[D]=Pq;var Vq={name:D,shader:Pq};var f="pbrPixelShader",_w=`#define PBR_FRAGMENT_SHADER
...
`;if(!q.ShadersStore[f])q.ShadersStore[f]=_w;var $w=[Mq,Uq,Eq,k,Dq,fq,aq,kq,qw,Lq,Rq,lq,E,ww,U,cq,Iq,Bq,yq,pq,Fq,xw,zw,Hw,iq,jq,eq,bq,Jw,Kw,rq,Qw,Tw,Ww,mq,tq,gq,hq,R,u,l,c,p,t,h,o,n,a,uq,qq,xq,Aq,Xw,Sq,Hq,dq,Kq,Tq,Xq,Zq,oq,$q,Gq,Oq,sq,Cq,Yw,Vq,nq,Zw];for(let w of $w)if(!q.IncludesShadersStore[w.name])q.IncludesShadersStore[w.name]=w.shader;var Lz={name:f,shader:_w};
export{Lz as zj};

//# debugId=9929707A69753EC064756E2164756E21
//# sourceMappingURL=site-zyc5a10v.js.map
