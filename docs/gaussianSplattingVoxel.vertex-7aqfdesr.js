import{_y as x}from"./site-6r14vnav.js";import{lA as w}from"./site-5xv9r9ax.js";import{mA as v}from"./site-8j04nt09.js";import{_B as f}from"./site-7jxv124x.js";import"./site-68gwymhw.js";var q="gaussianSplattingVoxelVertexShader",y=`#include<sceneUboDeclaration>
...
`;if(!f.ShadersStoreWGSL[q])f.ShadersStoreWGSL[q]=y;var z=[v,w,x];for(let k of z)if(!f.IncludesShadersStoreWGSL[k.name])f.IncludesShadersStoreWGSL[k.name]=k.shader;var F={name:q,shader:y};export{F as gaussianSplattingVoxelVertexShaderWGSL};

//# debugId=62ADC0ECDBB3207364756E2164756E21
//# sourceMappingURL=gaussianSplattingVoxel.vertex-7aqfdesr.js.map
