import{_B as b}from"./site-7jxv124x.js";var k="glowBlurPostProcessPixelShader",q=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 direction;uniform float blurWidth;float getLuminance(vec3 color)
...
gl_FragColor=baseColor;}`;if(!b.ShadersStore[k])b.ShadersStore[k]=q;var x={name:k,shader:q};
export{x as Km};

//# debugId=CE095402E98A5FB964756E2164756E21
//# sourceMappingURL=site-qmyvsvsm.js.map
